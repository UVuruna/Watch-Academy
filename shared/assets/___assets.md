...
- **The weekday tree** (WEEKDAY ALT ROTATION round, owner 2026-07-20/
  ...
  weekday-body resolver, [Config (folder)](../../desktop/config/___config.md))
...
[Continents (script)](../../desktop/core/__about/continents.md) for the Ninth easter-egg
law and [Encyclopedia (subfolder)](../../desktop/app/encyclopedia/___encyclopedia.md) for the topic.

## Connections

### Used by
- [Config (folder)](../../desktop/config/___config.md) — DEFAULT_SKIN + RING_PRESETS paths
- [Render (folder)](../../desktop/render/___render.md) — asset cache
- [Watch Controller](../../desktop/app/__about/controller.md) — weekday theme + zodiac art paths
