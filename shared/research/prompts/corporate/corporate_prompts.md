# The Corporation — the Boardroom Weekday Theme (Gemini/ChatGPT)

Owner-sealed roster, 2026-07-22 (GAMING + CORPORATION SHEET WAVE): a
NEW weekday theme, single roster (no blocks, no Planetary/Pantheon
split — the same "closed set" shape `monsters`/`chinese_myth` already
ship): six weekday executive seats, a Throne/Mirror dual, an Unfound
Ninth and a title plate. **Every figure is an ARCHETYPE, not a real
person** — the owner's own instruction, carried into every single
...
podium sermon, a boardroom seat, a garage-office sketch); `primary`/
`colored` is a fresh repaint, not a tint pass, same non-derivable
convention every sibling sheet uses. Nothing here is a candidate for
...
one documented exception, tracked separately — see the cross-reference
at the bottom). **Every figure is rendered as a FACELESS OR STYLIZED
silhouette-archetype — explicitly "no likeness of any real person" is
written into every single prompt below**, not just this header, since
these are corporate ROLES (CEO, CFO, …) rather than named individuals
and must never resolve toward any specific real executive.

**Drop paths:** `masters/weeks/crafts/corporate/primary/bronze/<Stem>.png` and
`masters/weeks/crafts/corporate/primary/colored/<Stem>.png`, both flat, no `dual/`
...
|---|---|---|
| Monday | blue · Fear/Serenity | **CHRO** |
| Tuesday | orange · Wrath/Courage | **COO** |
| Wednesday | purple · Greed/Wisdom | **CFO** |
| Thursday | yellow · Excess/Generosity | **CMO** |
| Friday | red · Jealousy/Love | **CDO** (Chief Design Officer) |
| Saturday | green · Envy/Patience | **CTO** |
| Sunday (Throne) | white-gold · Pride/Justice | **CEO** |
| Sunday (Mirror, dual) | black-silver · Servility/Humility | **Chairman of the Board** |
| Ninth (Unfound) | — | **The Founder** |
| Title plate | — | **The Boardroom Table** |
...
**CHRO** → `masters/weeks/crafts/corporate/primary/bronze/CHRO.png`
```
...
**CHRO (colored)** → `masters/weeks/crafts/corporate/primary/colored/CHRO.png`
```
...
**COO** → `masters/weeks/crafts/corporate/primary/bronze/COO.png`
```
...
**COO (colored)** → `masters/weeks/crafts/corporate/primary/colored/COO.png`
```
...
**CFO** → `masters/weeks/crafts/corporate/primary/bronze/CFO.png`
```
...
**CFO (colored)** → `masters/weeks/crafts/corporate/primary/colored/CFO.png`
```
...
**CMO** → `masters/weeks/crafts/corporate/primary/bronze/CMO.png`
```
...
**CMO (colored)** → `masters/weeks/crafts/corporate/primary/colored/CMO.png`
```
...
## Friday — CDO (Chief Design Officer)

*The creative eye — love of the work worn as fiercely as any jealousy.*

**CDO** → `masters/weeks/crafts/corporate/primary/bronze/CDO.png`
```
...
**CDO (colored)** → `masters/weeks/crafts/corporate/primary/colored/CDO.png`
```
...
**CTO** → `masters/weeks/crafts/corporate/primary/bronze/CTO.png`
```
...
**CTO (colored)** → `masters/weeks/crafts/corporate/primary/colored/CTO.png`
```
...
**CEO** → `masters/weeks/crafts/corporate/primary/bronze/CEO.png`
```
...
**CEO (colored)** → `masters/weeks/crafts/corporate/primary/colored/CEO.png`
```
...
## Sunday (Mirror, dual) — Chairman of the Board
...
**Chairman of the Board** → `masters/weeks/crafts/corporate/primary/bronze/Chairman.png`
```
...
**Chairman of the Board (colored)** → `masters/weeks/crafts/corporate/primary/colored/Chairman.png`
```
...
**The Founder** → `masters/weeks/crafts/corporate/primary/bronze/Founder.png`
```
...
**The Founder (colored)** → `masters/weeks/crafts/corporate/primary/colored/Founder.png`
```
...
**The Boardroom Table** is this theme's TITLE PLATE — the whole-theme
summary image every weekday theme carries a slot for. Brief and drop
path live in [Theme Title Prompts](../titles/theme_title_prompts.md),
NOT here — see that sheet's own "Cross-referenced" section. Do not
duplicate the brief in this file.

- **The Corporation** → `masters/weeks/societies/wolf/primary/colored/corporate.png`. Brief: an empty
  ...
  chip-and-root-network, a crown), the ninth left conspicuously bare —
  the "every seat's own emblem at once" device (`greek`/`cosmos`
  precedent) fused with the Founder's own "ghost seat" language into
  one composition.
...
- New sheet (R10 GAMING + CORPORATION SHEET WAVE, owner-sealed roster
  ...
  data-driven root, so every path in this sheet passes the sheet-path
  lint today with no whitelist entry needed.
- **No rotation seats in this theme** — every seat holds exactly one
  archetype; the `alt/` convention is not used anywhere in this file.
- **Content-safety note carried into every prompt, not just this
  header:** all nine figures are explicitly "FACELESS OR STYLIZED...
  no likeness of any real person" — the owner's own instruction, since
  these are corporate ROLES, never named individuals.
- **Art: 0/18** (9 figures × 2 registers; the title plate is tracked
  separately, see above).
- Verify with `python main.py "research/prompts/corporate/corporate_prompts.md" --dry-run`
