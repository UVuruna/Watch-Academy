...
ROTATION sibling, `masters/celestial/era/<source>/calendar/alt/Byzantine.png`,
...
Fixed the same round — the app reads `masters/celestial/era/<Name>.png` (or
...
ROTATION CONVENTION, [Assets (folder)](../../../../shared/assets/___assets.md)
...
unbroken years) → `masters/celestial/era/Age_of_Light.png`
...
`masters/celestial/era/Age_of_Darkness.png`
...
half) → `masters/celestial/era/Starry_Spring.png`
...
— WE LIVE HERE) → `masters/celestial/era/Starry_Summer.png`
...
half) → `masters/celestial/era/Starry_Autumn.png`
...
half) → `masters/celestial/era/Starry_Winter.png`
...
"kreni prozori" fix round, 2026-07-19) → `masters/celestial/era/Anno_Lucis.png`.
...
living at `masters/celestial/era/calendar/Byzantine_v2.png`, discovered by
`rotating_art_file` beside the canonical `Byzantine.png` — see its own
entry below.

**AUC — Ab Urbe Condita** (Rome, 753 BCE) →
`masters/celestial/era/calendar/AUC.png`
...
`masters/celestial/era/calendar/Byzantine.png`
...
`masters/celestial/era/calendar/Hebrew.png`
...
`masters/celestial/era/calendar/Hegirae.png`
...
`masters/celestial/era/calendar/Buddhist.png`
...
`masters/celestial/era/calendar/Huangdi.png`
...
`masters/celestial/era/calendar/Maya.png` (MAYA round, owner 2026-07-20)
...
`masters/celestial/era/calendar/KaliYuga.png` (ERA-TRIO round, owner 2026-07-20)
...
`masters/celestial/era/calendar/Olympiad.png` (ERA-TRIO round, owner 2026-07-20)
...
`masters/celestial/era/calendar/Unix.png` (ERA-TRIO round, owner 2026-07-20)
...
`masters/celestial/era/calendar/Byzantine_v2.png` (ERA-TRIO round, owner
2026-07-20)
...
CONVENTION, [Assets (folder)](../../../../shared/assets/___assets.md)): the β of
...
graceful-absent — see [Encyclopedia](../../../../desktop/app/encyclopedia/___encyclopedia.md));
...
- **SUPERSEDED (owner "kreni prozori" fix round, 2026-07-19):** the
  ...
  action required:** delete `masters/celestial/era/gemini/*.png` (the seven era7
...
- **Extended again (MAYA round, owner 2026-07-20 — "Jel Maje nisu
  ...
  not an offset — see [Deep Time](../../../../desktop/core/__about/deep_time.md)); this
...
- **Extended again (ERA-TRIO round, owner 2026-07-20 — "može sve 3"):**
  ...
  [Deep Time](../../../../desktop/core/__about/deep_time.md)). Also ground-truthed and
