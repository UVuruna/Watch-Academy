# Planets ART Medallion Prompts (Gemini)

This is the `planets_art` weekday theme's own complete sheet — split
out of `cosmos_prompts.md` (2026-07-15) so the theme owns one file, per
the owner's iron rule.
...
`assets/weeks/celestial_bodies/planets/primary/` (`masters/weeks/celestial_bodies/planets/primary/art/Sun.png` … `masters/weeks/celestial_bodies/planets/primary/art/Saturn.png`, real renders —
...
family sharing the star-chart border. Where Cosmos's Sun plate in
`cosmos_prompts.md` tells the *narrative* (light given away), these
plates are closer to classical planetary-medal *portraits* — each
body's real, photographed likeness translated into relief — so the
...
- `assets/weeks/celestial_bodies/planets/primary/art/` — `masters/weeks/celestial_bodies/planets/primary/art/Sun.png`, `masters/weeks/celestial_bodies/planets/primary/art/Moon.png`, `masters/weeks/celestial_bodies/planets/primary/art/Mars.png`,
  `masters/weeks/celestial_bodies/planets/primary/art/Mercury.png`, `masters/weeks/celestial_bodies/planets/primary/art/Jupiter.png`, `masters/weeks/celestial_bodies/planets/primary/art/Venus.png`, `masters/weeks/celestial_bodies/planets/primary/art/Saturn.png`
- `masters/weeks/celestial_bodies/planets/primary/art/Sun_Eclipse.png`
- Bronze only, no `colored/` arc requested for this section.

### Sun (`masters/weeks/celestial_bodies/planets/primary/art/Sun.png`)
...
### Moon (`masters/weeks/celestial_bodies/planets/primary/art/Moon.png`)
...
### Mars (`masters/weeks/celestial_bodies/planets/primary/art/Mars.png`)
...
### Mercury (`masters/weeks/celestial_bodies/planets/primary/art/Mercury.png`)
...
### Jupiter (`masters/weeks/celestial_bodies/planets/primary/art/Jupiter.png`)
...
### Venus (`masters/weeks/celestial_bodies/planets/primary/art/Venus.png`)
...
### Saturn (`masters/weeks/celestial_bodies/planets/primary/art/Saturn.png`)
...
### Sun eclipse (dual) (`masters/weeks/celestial_bodies/planets/primary/art/Sun_Eclipse.png`)
