...
entirely and, unlike Greek/Norse, never got a `colored/` companion
set; this sheet regenerates the eight bronze plates from the canon in
`Database/symbolism.json` so the owner can drop fresh renders straight
over the existing files, and adds the eight colored plates the theme
was missing.

**Border identity:** a bronze ring carved as a continuous **rodovik
solar-wheel (kolovrat) carving**, running clockwise, broken every
quarter turn by a **wheat-sheaf roundel** cradling the day's planetary
glyph — distinct from every other bronze theme's border (no meander,
no knotwork, no hieroglyphs).
...
**Sunday — Dažbog** → `masters/weeks/myth/slavic/primary/bronze/Dazbog.png`

*The giving sun, "vnutsi Dazhbozhi" — the article's own image of the
open-handed ancestor-lord.*

```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: Dažbog, a radiant youth crowned with a winged helm, an eagle spreading its wings above his brow, a corona of long rays behind his head like a second sun, a horn of plenty cradled in one arm spilling coins and ripe wheat, a scepter capped with a blazing sun-star lifted in the other hand. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Sun glyph in relief. No text, no watermark.
```

**Monday — Hors** → `masters/weeks/myth/slavic/primary/bronze/Hors.png`

*The night's light, "crossed by great Hors" in the Tale of Igor's
Campaign — the wheel of pale fire across the dark.*

```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: Hors crowned with a horned crescent cradling a full moon between its tips, his cloak stamped with a running row of moon-phases from new to full and back, a staff capped with a crescent lifted in his hand, deep starry night behind him. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Moon crescent glyph in relief. No text, no watermark.
```

**Tuesday — Svetovid** → `masters/weeks/myth/slavic/primary/bronze/Svetovid.png`

*The four-faced war-god of Arkona, the mead horn read as omen and the
sacred white horse of the temple.*

```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: the four-faced Svetovid under one crested helm, the carved faces watching their quarters, in a coat of scale mail, a mead horn raised in one hand and a bow in the other, the great sword at his belt, a spear beside him carrying the sacred white horse on its banner, two mailed guardsmen kneeling at the pedestal. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Mars glyph in relief. No text, no watermark.
```

**Wednesday — Veles** → `masters/weeks/myth/slavic/primary/bronze/Veles.png`

*The horned cattle-god of trade, song and the underworld, the serpent
at the roots of the world-tree.*

```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: Veles, a horned, long-bearded god seated on a throne of living tree-roots, wrapped in a shaggy beast-pelt, a shepherd's crook in one hand and a lyre cradled in the other, cattle and sheep grazing around his knees, a great serpent coiling through the roots at his feet. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Mercury glyph in relief. No text, no watermark.
```

**Thursday — Perun** → `masters/weeks/myth/slavic/primary/bronze/Perun.png`

*The thunder-god at the storm's center, axe in one hand, the bolt that
frees the withheld rain in the other.*

```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: Perun, a broad, bearded warrior in ornate armor and a winged helm, hurling a bolt of brilliant lightning from his raised right hand, a great battle-axe hanging ready in his left, storm-clouds boiling around him, mountains standing below. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Jupiter glyph in relief. No text, no watermark.
```

**Friday — Mokoš** → `masters/weeks/myth/slavic/primary/bronze/Mokos.png`

*The only goddess in Vladimir's Kyiv pantheon, spinner of the thread
and Moist Mother Earth herself.*

```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: Mokoš, a veiled woman in a copper-bronze robe with a shawl over her long hair, turning a distaff wound with pale flax in her raised hand, a curved harvest-sickle across her lap, full sheaves of ripe wheat standing to either side, a serpent coiled at her feet. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Venus glyph in relief. No text, no watermark.
```

**Saturday — Morana** → `masters/weeks/myth/slavic/primary/bronze/Morana.png`

*Winter and death as a hinge, not an end — the straw effigy drowned
each spring so the year can turn.*
...
**Sunday (dual) — Old Dažbog** → `masters/weeks/myth/slavic/primary/bronze/Dazbog_Old.png`
...
```
Ornate circular medallion, aged bronze relief, photorealistic render, perfectly centered, isolated on white background. Center: an aged Dažbog, gray-bearded, his once-golden winged helm dulled and rimed with frost, walking bent along a frozen road, the corona behind his head dimmed to a thin gray-silver ring, the horn of plenty at his side emptied and cracked, bare wintry trees standing around him — the same sun-king grown old, trusting the spring to crown him again. Border: bronze ring carved as a continuous rodovik solar-wheel (kolovrat) band, broken by four wheat-sheaf roundels, each cradling the Sun glyph in relief. No text, no watermark.
```
...
dual under `masters/weeks/myth/slavic/primary/colored/Dazbog_Old.png`.

**Dažbog (sunday)** → `masters/weeks/myth/slavic/primary/colored/Dazbog.png`

```
Ornate circular badge, vivid full-color Slavic folk-icon style, warm earth-and-gold palette, photorealistic render, perfectly centered, isolated on white background. Center: Dažbog radiant in gold and amber, silver skin glowing beneath a golden winged helm, a golden eagle spread above his brow, a corona of long golden rays blazing behind his head, a horn of plenty spilling silver coins and gold wheat in one arm, a sun-star scepter raised in the other. Border: gold rodovik solar-wheel carving, broken by four painted wheat-sheaf roundels in ripe gold, each framing the Sun glyph. Colors: gold, amber, silver skin, warm wheat.
```

**Hors (monday)** → `masters/weeks/myth/slavic/primary/colored/Hors.png`

```
Ornate circular badge, vivid full-color Slavic folk-icon style, warm earth-and-gold palette, photorealistic render, perfectly centered, isolated on white background. Center: Hors in silver-blue skin under a horned crescent cradling a glowing full moon, his cloak silvered with a painted row of moon-phases, a crescent-capped staff lifted against a deep indigo night sky. Border: silver rodovik solar-wheel carving, broken by four painted wheat-sheaf roundels in pale silver-gold, each framing the Moon crescent glyph. Colors: silver-blue, indigo night, pale moonlight, muted gold.
```

**Svetovid (tuesday)** → `masters/weeks/myth/slavic/primary/colored/Svetovid.png`

```
Ornate circular badge, vivid full-color Slavic folk-icon style, warm earth-and-gold palette, photorealistic render, perfectly centered, isolated on white background. Center: the four-faced Svetovid in gleaming bronze scale mail under a crimson-crested helm, a golden mead horn raised in one hand, a bow in the other, the sacred white horse rearing on a banner beside him against a fiery ember sky. Border: bronze rodovik solar-wheel carving, broken by four painted wheat-sheaf roundels in ember gold, each framing the Mars glyph. Colors: crimson, ember orange, bronze mail, ivory horse.
```

**Veles (wednesday)** → `masters/weeks/myth/slavic/primary/colored/Veles.png`

```
Ornate circular badge, vivid full-color Slavic folk-icon style, warm earth-and-gold palette, photorealistic render, perfectly centered, isolated on white background. Center: Veles horned and long-bearded, seated on a throne of living tree-roots in a shaggy brown pelt, a gold-strung lyre cradled in one hand and a wooden crook in the other, cattle grazing in warm earth tones around him against a glowing teal-green underworld field. Border: teal-green rodovik solar-wheel carving, broken by four painted wheat-sheaf roundels in dull gold, each framing the Mercury glyph. Colors: teal underworld green, warm brown pelt, gold lyre.
```

**Perun (thursday)** → `masters/weeks/myth/slavic/primary/colored/Perun.png`

```
Ornate circular badge, vivid full-color Slavic folk-icon style, warm earth-and-gold palette, photorealistic render, perfectly centered, isolated on white background. Center: Perun in gleaming gold-trimmed armor and a winged helm, a bolt of brilliant white-blue lightning blazing from his raised hand, a bronze battle-axe in his left, dark storm-blue clouds boiling behind him over green mountains. Border: gold rodovik solar-wheel carving, broken by four painted wheat-sheaf roundels in storm gold, each framing the Jupiter glyph. Colors: storm blue, gold armor, lightning white, mountain green.
```

**Mokoš (friday)** → `masters/weeks/myth/slavic/primary/colored/Mokos.png`

```
Ornate circular badge, vivid full-color Slavic folk-icon style, warm earth-and-gold palette, photorealistic render, perfectly centered, isolated on white background. Center: Mokoš veiled in a warm copper-bronze robe, turning a distaff of pale flax in golden light, a curved sickle across her lap, full sheaves of ripe golden wheat standing to either side against a warm earth-brown field. Border: copper-bronze rodovik solar-wheel carving, broken by four painted wheat-sheaf roundels in ripe gold, each framing the Venus glyph. Colors: copper bronze, earth brown, golden wheat.
```

**Morana (saturday)** → `masters/weeks/myth/slavic/primary/colored/Morana.png`
...
**Old Dažbog (sunday dual)** → `masters/weeks/myth/slavic/primary/colored/Dazbog_Old.png`
...
**Sunday — Perun** → REUSE `masters/weeks/myth/slavic/primary/bronze/Perun.png`
...
**Monday — Mokoš** → REUSE `masters/weeks/myth/slavic/primary/bronze/Mokos.png`
...
**Tuesday — Svetovid** → REUSE `masters/weeks/myth/slavic/primary/bronze/Svetovid.png`
...
**Wednesday — Svarog** → `masters/weeks/myth/slavic/pantheon/bronze/Svarog.png`
...
**Thursday — Dažbog** → REUSE `masters/weeks/myth/slavic/primary/bronze/Dazbog.png`
...
**Friday — Lada** → `masters/weeks/myth/slavic/pantheon/bronze/Lada.png`
...
**Saturday — Morana** → REUSE `masters/weeks/myth/slavic/primary/bronze/Morana.png`
...
**Sunday (dual), shadow face — Veles** → REUSE `masters/weeks/myth/slavic/primary/bronze/Veles.png`
...
**Thursday — Dažbog** → REUSE `masters/weeks/myth/slavic/primary/colored/Dazbog.png`

```
REUSE — no new render. Pantheon Thursday reseats `slavic/colored/dazbog.png` verbatim (Planetary Sunday's colored plate).
```

**Friday — Lada** → `masters/weeks/myth/slavic/pantheon/colored/lada.png`
...
**Saturday — Morana** → REUSE `masters/weeks/myth/slavic/primary/colored/Morana.png`

```
REUSE — no new render. Pantheon Saturday reuses `slavic/colored/morana.png` verbatim — same seat, both rosters.
```

**Sunday (dual), shadow face — Veles** → REUSE `masters/weeks/myth/slavic/primary/colored/Veles.png`
...
## The Ninth — Triglav (`masters/weeks/myth/slavic/primary/bronze/Triglav.png`)
...
**Triglav (colored)** → `masters/weeks/myth/slavic/primary/colored/Triglav.png`
```
...
**Planetary set — unchanged, already on disk:** `masters/weeks/myth/slavic/primary/bronze/Dazbog.png` ·
`masters/weeks/myth/slavic/primary/bronze/Hors.png` · `masters/weeks/myth/slavic/primary/bronze/Svetovid.png` · `masters/weeks/myth/slavic/primary/bronze/Veles.png` · `masters/weeks/myth/slavic/primary/bronze/Perun.png` · `masters/weeks/myth/slavic/primary/bronze/Mokos.png`
· `masters/weeks/myth/slavic/primary/bronze/Morana.png` · `masters/weeks/myth/slavic/primary/bronze/Dazbog_Old.png`, plus all eight `colored/`
companions and `masters/weeks/myth/slavic/primary/colored/Dazbog_Old.png`. Nothing to regenerate.

**New art this pass — generate in this order, one chat session per
register so each series stays consistent:**

- [ ] `masters/weeks/myth/slavic/pantheon/bronze/Svarog.png` — bronze, NEW
- [ ] `masters/weeks/myth/slavic/pantheon/bronze/Lada.png` — bronze, NEW
- [ ] `masters/weeks/myth/slavic/primary/bronze/Triglav.png` — bronze, NEW (supersedes `crnobog.png` — do NOT
      generate `crnobog.png`)
- [ ] `masters/weeks/myth/slavic/pantheon/colored/svarog.png` — colored, NEW
- [ ] `masters/weeks/myth/slavic/pantheon/colored/lada.png` — colored, NEW
- [ ] `masters/weeks/myth/slavic/primary/colored/Triglav.png` — colored, NEW

**REUSE only — no art to generate, `figure_roster: pantheon` just
points at the existing file:**

- [x] Pantheon Sunday → `primary/perun.png` + `masters/weeks/myth/slavic/primary/colored/Perun.png`
- [x] Pantheon Monday → `primary/mokos.png` + `masters/weeks/myth/slavic/primary/colored/Mokos.png`
- [x] Pantheon Tuesday → `primary/svetovid.png` + `masters/weeks/myth/slavic/primary/colored/Svetovid.png`
- [x] Pantheon Thursday → `primary/dazbog.png` + `masters/weeks/myth/slavic/primary/colored/Dazbog.png`
- [x] Pantheon Saturday → `primary/morana.png` + `masters/weeks/myth/slavic/primary/colored/Morana.png`
- [x] Pantheon Sunday dual (shadow face) → `primary/veles.png` +
      `masters/weeks/myth/slavic/primary/colored/Veles.png`
...
**Crnobog (wider, bronze)** → `masters/weeks/myth/slavic/wider/bronze/crnobog.png`
...
**Stribog (wider, bronze)** → `masters/weeks/myth/slavic/wider/bronze/stribog.png`
...
**Jarilo (wider, bronze)** → `masters/weeks/myth/slavic/wider/bronze/jarilo.png`
...
**Rod (wider, bronze)** → `masters/weeks/myth/slavic/wider/bronze/rod.png`
