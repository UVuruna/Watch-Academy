# Chinese Mythology — the Immortals Weekday Theme (Gemini/ChatGPT)

Owner-approved 2026-07-21 night: a NEW weekday theme, single roster (no
Planetary/Pantheon split — six weekday seats, a Sunday dual, a Ninth and
a title plate, the same "closed set" shape wolf/bee/elephant/cosmos
already ship). NOT to be confused with the existing `chinese`
ZODIAC-ANIMAL theme (`zodiac/chinese_zodiac_prompts.md`, twelve animals,
year-reading) — this is a separate cast of gods, immortals and one
stone-born rebel, seated by NATURE against the seat's own color/virtue/
vice bundle (CANON.md), not by animal-year at all.

**Register — its OWN family, not the Greek key:** cloud-scroll borders
(xiangyun, the auspicious-cloud motif that runs through Chinese temple
and lacquerware ornament) in a jade-and-lacquer palette — deliberately
NOT the Olympian meander, NOT the wolf paw-trail, NOT any bronze theme's
ring, exactly the owner's own instruction. Like the greek monsters
sheet, this theme wears the house **night-window** stained-glass
register (`era_prompts.md`, `months_prompts.md`'s family) rather than a
metal relief, so its dark jewel-glass reads as myth rather than
portraiture. Every plate carries a `primary/` night-window version and
a `colored/` full-vivid version, the same two-register convention every
other weekday theme ships.

**Derivation check (Rule #19):** every plate is an irreducible scene —
a different figure, a different myth-beat; the `primary`/`colored`
split is a fresh full-color repaint, not a tint pass (the same
non-derivable convention `greek_prompts.md`/`cosmos_prompts.md` already
use). Nothing here is a candidate for algorithmic collapse.

**House rules:** photorealistic render, isolated background (no
transparency-checkerboard artifact), the circular window/badge shape IS
the frame, NO lettering anywhere in any image (the title plate is the
one documented exception in this whole project, and it lives in its OWN
file/root — see the cross-reference at the bottom).

**Drop paths:** `masters/weeks/myth/celestial_court/primary/bronze/<Stem>.png`
(night-window) and `masters/weeks/myth/celestial_court/primary/colored/<Stem>.png`
(full enamel) — both flat, no `dual/` subfolder.
...
## Monday — Chang'e (`masters/weeks/myth/celestial_court/primary/bronze/ChangE.png`)

*The moon goddess; the Jade Rabbit grinding the elixir — medicine ON
the moon, not merely a light in the sky.*

```
ROUND rose-window stained-glass medallion, night-window register, photorealistic render, isolated background, the circular window shape IS the frame. Cool jade-green and pale silver-blue glass, weightless and still. Center: Chang'e adrift on the surface of a vast full moon, flowing silk robes trailing into starlight, a white jade rabbit crouched beside her working a mortar and pestle, fine silver dust rising from the grinding elixir. A cassia tree grows rootless at the moon's own edge behind her. Border: leadwork rim carved as a continuous cloud-scroll (xiangyun) band, broken by four small roundels bearing the Moon crescent glyph in dark leadwork relief. Palette: jade green, silver-blue, pale moon-white, one warm elixir-gold accent. NO lettering anywhere.
```

**Chang'e (colored)** → `masters/weeks/myth/celestial_court/primary/colored/ChangE.png`
```
Ornate circular badge, vivid full-color enamel over jade and lacquer-gold, photorealistic render, perfectly centered, isolated on white background. Center: Chang'e in full color, flowing rose-white silk robes drifting across a glowing silver-white moon, a snow-white jade rabbit grinding a mortar of glowing golden elixir dust beside her, a rootless cassia tree at the moon's rim. Border: the same cloud-scroll (xiangyun) band recut in polished jade-green and lacquer-gold, four enamel roundels bearing a silver Moon crescent. Colors: jade green, silk rose-white, elixir gold, silver moonlight.
```

---

## Tuesday — Erlang Shen (`masters/weeks/myth/celestial_court/primary/bronze/Erlang_Shen.png`)
...
**Erlang Shen (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Erlang_Shen.png`
```
...
## Wednesday — Guan Yu (`masters/weeks/myth/celestial_court/primary/bronze/Guan_Yu.png`)
...
**Guan Yu (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Guan_Yu.png`
```
...
## Thursday — Zhu Bajie (`masters/weeks/myth/celestial_court/primary/bronze/Zhu_Bajie.png`)
...
**Zhu Bajie (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Zhu_Bajie.png`
```
...
## Friday — Zhinü (`masters/weeks/myth/celestial_court/primary/bronze/Zhinu.png`)

*THE Chinese love story — the loom, the magpie bridge, the sky that
separates the Weaver Girl from her cowherd once a year.*

```
ROUND rose-window stained-glass medallion, night-window register, photorealistic render, isolated background, the circular window shape IS the frame. Deep rose-red and star-scattered indigo glass, longing and warm. Center: Zhinü seated at a great loom, cloud-silk threads streaming from her hands into the night sky itself, gazing across a wide starry river (the Milky Way) toward a small distant figure on the far bank; a bridge of wing-to-wing magpies arcs faintly between them, visible only once a year. Border: leadwork rim carved as a continuous cloud-scroll (xiangyun) band, broken by four small roundels bearing the Venus glyph in dark leadwork relief. Palette: rose-red, star-indigo, silver thread, one warm gold accent at the bridge. NO lettering anywhere.
```

**Zhinü (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Zhinu.png`
```
Ornate circular badge, vivid full-color enamel over jade and lacquer-gold, photorealistic render, perfectly centered, isolated on white background. Center: Zhinü in full color, flowing rose-pink silk robes at a golden loom, silver-threaded cloud-silk spilling into a deep indigo starry river, a faint bridge of black-and-white magpies arcing toward a small distant figure on the far bank. Border: the cloud-scroll band recut in jade-green and lacquer-gold, four enamel roundels bearing a red Venus glyph. Colors: rose pink, indigo starlight, silver thread, magpie black-and-white.
```

---

## Saturday — Shennong (`masters/weeks/myth/celestial_court/primary/bronze/Shennong.png`)

*The Divine Farmer — tasted the hundred herbs, invented the plough;
patience proven one bitter leaf at a time.*

```
ROUND rose-window stained-glass medallion, night-window register, photorealistic render, isolated background, the circular window shape IS the frame. Deep jade-green and earthen-brown glass, patient and rooted. Center: Shennong kneeling in a terraced field, ox-horned brow and rough farmer's robes, one hand holding a wooden plough's handle at rest, the other lifting a single unknown herb leaf to his lips to taste and judge, a woven basket of gathered plants at his knee. Border: leadwork rim carved as a continuous cloud-scroll (xiangyun) band, broken by four small roundels bearing the Saturn glyph in dark leadwork relief. Palette: jade green, earthen brown, ox-horn grey, one small herb-leaf accent. NO lettering anywhere.
```

**Shennong (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Shennong.png`
```
Ornate circular badge, vivid full-color enamel over jade and lacquer-gold, photorealistic render, perfectly centered, isolated on white background. Center: Shennong in full color, small ox-horns above a weathered farmer's face, rough earth-brown robes, kneeling in a green terraced field with a wooden plough at rest and a woven basket of gathered herbs at his knee, lifting one leaf to taste. Border: the cloud-scroll band recut in jade-green and lacquer-gold, four enamel roundels bearing a green Saturn glyph. Colors: jade green, earthen brown, ox-horn grey, herb-leaf accent.
```

---

## Sunday — Sun Wukong (Ruler face, dual, `masters/weeks/myth/celestial_court/primary/bronze/Sun_Wukong.png`)
...
**Sun Wukong (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Sun_Wukong.png`
```
...
## Sunday — the Six-Eared Macaque (Servant face, dual, `masters/weeks/myth/celestial_court/primary/bronze/Six_Eared_Macaque.png`)
...
**The Six-Eared Macaque (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Six_Eared_Macaque.png`
```
...
## The Ninth (Excluded) — Buddha (`masters/weeks/myth/celestial_court/primary/bronze/Buddha.png`)
...
**Buddha (colored)** → `masters/weeks/myth/celestial_court/primary/colored/Buddha.png`
```
...
## Cross-reference — the title plate

**The Peach Banquet** is this theme's TITLE PLATE — the whole-theme
summary image every weekday theme carries a slot for
(`app.encyclopedia._weekday_topic`'s `title_entry`). Chosen over "the
celestial court panorama" (the sheet's own call, per the owner's
brief) for two reasons: (1) a banquet stages as ONE coherent circular
...
- New sheet (R8c PROMPT SHEETS round, owner-approved 2026-07-21 night).
  Theme not yet registered in `config/defaults.py` — that wiring is a
  FUTURE app-code round, out of this sheet-writing round's scope.
  `assets/weekday/**` is a data-driven root
...
- **SEALED v2 (owner 2026-07-21, "Bravo, sve mi se sviđa"):** the
  ...
  one seat traded for another, not added), so no `assets/weeks/societies/wolf/primary/colored/`
