...
**Drop paths:** `masters/archetypes/<family>/circle/colored/<Stem>.png`
— beside the lancet, in the family's own `circle` REGISTER.

*(This sheet used to declare a staging root of its own under a
top-level "badge" folder, "deliberately NOT nested inside the
archetypes tree". That predates the
TREE LAW, which allows exactly five category roots — generating from the
old wording would have created a sixth, illegal one. The relocation map
in `RESTRUCTURE.md` already ruled the badge belongs beside its lancet,
and the `circle` register exists on disk for a dozen families, so the
staging idea is retired. Owner decree 2026-07-28: no sheet may name a
folder the tree does not have.)*
...
by eye. The source is the filename SUFFIX (`_gem` / `_gpt`), never a
folder — both engines may fill the same register.
...
**One — the Judge** (gold, 12h) → `masters/archetypes/trinity/circle/colored/One_Judge.png`
...
**the Devil — the Prosecutor** (red, 20h) → `masters/archetypes/trinity/circle/colored/Devil_Prosecutor.png`
...
**Jesus — the Advocate** (blue, 04h) → `masters/archetypes/trinity/circle/colored/Jesus_Advocate.png`
...
**the Child — the Dawn** (green, 12h) → `masters/archetypes/family/circle/colored/Child_Anchor.png`
...
**the Mother — the Heart** (light red, 20h) → `masters/archetypes/family/circle/colored/Mother_Heart.png`
...
**the Father — the Shield** (light blue, 04h) → `masters/archetypes/family/circle/colored/Father_Shield.png`
...
**Sanguine — the Companion** (spring green `#129412`) → `masters/archetypes/temperaments/circle/colored/Sanguine.png`
...
**Choleric — the Commander** (summer yellow `#D9D900`) → `masters/archetypes/temperaments/circle/colored/Choleric.png`
...
**Melancholic — the Thinker** (autumn red `#D4330F`) → `masters/archetypes/temperaments/circle/colored/Melancholic.png`
...
**Phlegmatic — the Peacemaker** (winter blue `#0A70D8`) → `masters/archetypes/temperaments/circle/colored/Phlegmatic.png`
...
**The One — Love** (yellow, 12h) → `masters/archetypes/persons/circle/colored/One_Love.png`
...
**Michael the Archangel — Courage** (orange, 16h) → `masters/archetypes/persons/circle/colored/Michael_Courage.png`
...
**Lucifer — Pride** (red, 20h) → `masters/archetypes/persons/circle/colored/Lucifer_Pride.png`
...
**the Devil — Hatred** (purple, 24h) → `masters/archetypes/persons/circle/colored/Devil_Hatred.png`
...
**Judas — Weakness (Fear)** (blue, 04h) → `masters/archetypes/persons/circle/colored/Judas_Fear.png`
...
**Jesus — Humility** (green, 08h) → `masters/archetypes/persons/circle/colored/Jesus_Humility.png`
...
**Gratitude** (green, 12h) → `masters/archetypes/one_soul/circle/colored/Gratitude.png`
...
**Support** (yellow, 16h) → `masters/archetypes/one_soul/circle/colored/Support.png`
...
**Passion** (red, 20h) → `masters/archetypes/one_soul/circle/colored/Passion.png`
...
**Tolerance** (magenta, 24h) → `masters/archetypes/one_soul/circle/colored/Tolerance.png`
...
**Trust** (blue, 04h) → `masters/archetypes/one_soul/circle/colored/Trust.png`
...
**Respect** (cyan, 08h) → `masters/archetypes/one_soul/circle/colored/Respect.png`
...
**The King** (royal gold, 12h) → `masters/archetypes/walks/circle/colored/King.png`
...
**The Merchant** (copper, 15h) → `masters/archetypes/walks/circle/colored/Merchant.png`
...
**The Soldier** (iron-blood crimson, 18h) → `masters/archetypes/walks/circle/colored/Soldier.png`
...
**The Artist** (stage velvet violet, 21h) → `masters/archetypes/walks/circle/colored/Artist.png`
...
**The Wanderer** (road-dust indigo-charcoal, 24h) → `masters/archetypes/walks/circle/colored/Wanderer.png`
...
**The Scholar** (lamplit ink blue, 03h) → `masters/archetypes/walks/circle/colored/Scholar.png`
...
**The Farmer** (field green, 06h) → `masters/archetypes/walks/circle/colored/Farmer.png`
...
**The Priest** (alb ivory, 09h) → `masters/archetypes/walks/circle/colored/Priest.png`
...
**the Unborn — the seed** (predawn mist `#8FA8C8`, 03h) → `masters/archetypes/life/circle/colored/Unborn.png`
...
**Birth — the sprout** (pale rose `#FFD9CC`, 06h) → `masters/archetypes/life/circle/colored/Birth.png`
...
**Childhood — the sapling** (spring green `#7CE577`, 09h) → `masters/archetypes/life/circle/colored/Childhood.png`
...
**Youth — the blossoming crown** (sun yellow `#FFE800`, 12h) → `masters/archetypes/life/circle/colored/Youth.png`
...
**Maturity — the full crown** (amber `#FFB400`, 15h) → `masters/archetypes/life/circle/colored/Maturity.png`
...
**the Elder — the fruited crown** (ember `#FF6A3C`, 18h) → `masters/archetypes/life/circle/colored/Elder.png`
...
**Old age — the leaf-fall** (dusk violet `#9C6BD4`, 21h) → `masters/archetypes/life/circle/colored/Old_Age.png`
...
**Death — the bare tree** (moonlight silver `#C8D7F0`, 24h) → `masters/archetypes/life/circle/colored/Death.png`
...
- **Wiring is UNDECIDED (owner call, DO NOT invent further):** these
  ...
  own mockup; no code reads `assets/archetypes/<family>/circle/colored/**` yet. Whitelisted
