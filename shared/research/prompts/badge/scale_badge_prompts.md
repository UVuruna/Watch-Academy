...
(the original set — the art exists at `assets/archetypes/scale/primary/colored/`)
...
- Metal cameo: `masters/archetypes/scale/primary/colored/Lucifer.png`,
  `masters/archetypes/scale/primary/colored/Judas.png`, `masters/archetypes/scale/primary/colored/Union.png`
...
## Design Notes — One Scale, Two Poles, One Union

**The celestial canon (fixed across the project, restated so the
sheets agree):** the scale measures self-exaltation against
self-betrayal. **Lucifer** is the pole of self-love — the morning
star that would rise above the heights, the UP-pointing triangle, the
dial's masculine Flame; his death is the supernova (a star destroying
itself outward — `bible_dark_prompts.md`). **Judas** is the pole of
self-hate — the betrayer of the light he loved, the DOWN-pointing
triangle, the dial's feminine Chalice inverted into a noose and
thirty coins; his death is the black hole (a star collapsing into
itself). **The Union** interlaces both triangles into the Seal — the
dial's own hexagram — around an EMPTY center: the zero of the scale
where the Sun stands, light given away, neither exploding nor
collapsing (the same zero the Moods' Ninth reads as the two triangles
balancing at null).

| Badge | Triangle | Metal & field | Rim devices |
|---|---|---|---|
| Lucifer | UP, a living flame inside | warm copper-bronze on near-black iron | two engraved falling stars, one small toppled crown |
| Judas | DOWN, deliberately EMPTY | cold brushed steel on dark gunmetal | a knotted rope noose at the top, thirty scattered coins pooling at the bottom |
| Union | BOTH interlaced, blank white roundel center | warm copper over cold steel on dark iron | a faint falling star above, rope segments along the lower rim, a tiny balance scale at the bottom center |

---

## The three badges

**Lucifer Triangle** → `masters/archetypes/scale/primary/colored/Lucifer.png`
...
**Judas Triangle** → `masters/archetypes/scale/primary/colored/Judas.png`
...
**The Union** → `masters/archetypes/scale/primary/colored/Union.png`
...
and one **symbolic** — the clear-hearted rose window. Hell is what
happened because they never met; the Meeting is what would have
happened if they had.

**Judas Triangle — glass** → `masters/archetypes/scale/glass/colored/Judas.png`
...
**Lucifer Triangle — glass** → `masters/archetypes/scale/glass/colored/Lucifer.png`
...
**Judas Triangle — glass v2** → `masters/archetypes/scale/glass/colored/Judas_v2.png`
...
**Lucifer Triangle — glass v2** → `masters/archetypes/scale/glass/colored/Lucifer_v2.png`
*(GPT's own unprompted variant — the bat-winged fall with the figure
in the light he is losing)*

```
UPWARD-pointing triangular stained-glass window, night-window register, photorealistic render, isolated background, the window shape IS the triangle. Deep crimson and blood-red glass throughout, no cold tones. Center: the rebel seen from behind, mid-fall yet still reaching — dark BAT-MEMBRANE wings spread wide and already torn at the edges, one arm stretched up toward the apex where a radiant robed FIGURE stands inside a white-gold burst of rays that break through boiling red cloudglass; his drapery shredding into the storm below, faint lightning veins in the cloud panes. Border: twisted thorn-and-rope leadwork in dark bronze-red; an eight-point star roundel at the apex, a falling-comet roundel at one base corner, a golden crown roundel at the other. Palette: crimson, blood red, white-gold radiance at the apex only, dark bronze lead. NO lettering anywhere.
```
...
**The Union I — the Meeting (figurative)** → `masters/archetypes/scale/glass/colored/Union_v2.png`
...
with love of self, Judas's with hate of self — met, each is the
other's antidote. Hell is the history where they never met; this
window is the history that never happened. The ideal of objectivity
AS PERSONS.)*
...
**The Union II — the Seal (symbolic)** → `masters/archetypes/scale/glass/colored/Union.png`
