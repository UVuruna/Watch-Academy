...
families) — the app reads `masters/celestial/eclipse/<Name>.png` directly
...
[Layers](../../../../desktop/render/layers/___layers.md) §THE STATE TABLE): the copper blood
...
**Total Solar Eclipse** — the pearl corona → `masters/celestial/eclipse/Solar_Total.png`
...
**Annular Solar Eclipse** — the ring of fire → `masters/celestial/eclipse/Solar_Annular.png`
...
**Partial Solar Eclipse** — the curved bite → `masters/celestial/eclipse/Solar_Partial.png`
...
**Hybrid Solar Eclipse** — total and annular at once → `masters/celestial/eclipse/Solar_Hybrid.png`
...
**Total Lunar Eclipse** — the blood moon → `masters/celestial/eclipse/Lunar_Total.png`
...
**Partial Lunar Eclipse** — the round shadow's bite → `masters/celestial/eclipse/Lunar_Partial.png`
...
**Penumbral Lunar Eclipse** — the faint veil → `masters/celestial/eclipse/Lunar_Penumbral.png`
...
- Wiring is LIVE and graceful-absent: `masters/celestial/eclipse/<Name>.png` backs
