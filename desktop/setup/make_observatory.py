...
TARGET_SEASONS = SHARED / "Database" / "observatory_seasons.json"
TARGET_ECLIPSES = SHARED / "Database" / "observatory_eclipses.json"
TARGET_ENVELOPE = SHARED / "Database" / "observatory_envelope.json"
