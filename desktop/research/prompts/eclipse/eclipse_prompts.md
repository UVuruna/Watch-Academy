...
**Total Solar Eclipse** — the pearl corona → `assets/celestial/eclipse/Solar_Total.png`
...
**Annular Solar Eclipse** — the ring of fire → `assets/celestial/eclipse/Solar_Annular.png`
...
**Partial Solar Eclipse** — the curved bite → `assets/celestial/eclipse/Solar_Partial.png`
...
**Hybrid Solar Eclipse** — total and annular at once → `assets/celestial/eclipse/Solar_Hybrid.png`
...
**Total Lunar Eclipse** — the blood moon → `assets/celestial/eclipse/Lunar_Total.png`
...
**Partial Lunar Eclipse** — the round shadow's bite → `assets/celestial/eclipse/Lunar_Partial.png`
...
**Penumbral Lunar Eclipse** — the faint veil → `assets/celestial/eclipse/Lunar_Penumbral.png`
