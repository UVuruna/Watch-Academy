...
| 6 | `tetramorph_hover.png` | tetramorf tri kolone (biće+jevanđelista+element) | Seasons secondary arhetip, hover na Lava |
...
| 11 | `mason_g_crown_text.png` | Mason prsten sa moto lukovima | Design ▸ Ring ▸ Mason |
