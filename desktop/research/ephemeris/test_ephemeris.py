...
DESKTOP_ROOT = os.path.dirname(os.path.dirname(HERE))  # desktop/
# THE THREE-FOLDER MIGRATION (2026-08-12): Database/ lives one level up
# from the desktop Python root, under shared/.
SHARED_DIR = os.path.join(os.path.dirname(DESKTOP_ROOT), "shared")
SEASONS = os.path.join(SHARED_DIR, "Database", "seasons_utc.json")
MOONS = os.path.join(SHARED_DIR, "Database", "moonPhases_utc.json")
