...
# THE ART BAKERY (owner decree 2026-08-12) reads this SAME table as its
# downscale plan — `setup/make_art_bake.py`, one source of truth for
# "how big may this area's art be". `celestial/era` and
