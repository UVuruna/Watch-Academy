...
from config import continents as continents_theme, defaults, ninth, pantheon, paths, registry
...
def _weekday_topic(theme: str, travel_date: date | None = None):
    ...
    metal = theme in registry.METAL_THEMES
    mandate_date = (
        travel_date
...
def _pantheon_topic(theme: str) -> list[dict]:
    ...
    follows the theme's OWN rule (`theme in registry.METAL_THEMES`) —
