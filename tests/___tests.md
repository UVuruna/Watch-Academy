...
| `test_moon_band.py` | THE MOON HORIZON BAND (owner verdict 2026-08-09): `core.moon.moon_horizon_arcs` geometry — both-None full circle, rise-only/set-only midnight anchoring, the ordinary single arc, the up-across-midnight two-arc split, and the golden Belgrade 2025-06-20 mockup day against `time_to_dial_angle` directly. |
