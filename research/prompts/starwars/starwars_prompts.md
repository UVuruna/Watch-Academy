...
**Leia, General Organa** → `assets/weeks/films/sw_jedi/primary/bronze/Leia.png`
```
...
**Leia, General Organa (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Leia.png`
```
...
**Han Solo** → `assets/weeks/films/sw_jedi/primary/bronze/Han.png`
```
...
**Han Solo (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Han.png`
```
...
**Padmé** → `assets/weeks/films/sw_jedi/primary/bronze/Padme.png`
```
...
**Padmé (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Padme.png`
```
...
**Chewbacca** → `assets/weeks/films/sw_jedi/primary/bronze/Chewbacca.png`
```
...
**Chewbacca (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Chewbacca.png`
```
...
**Young Luke** → `assets/weeks/films/sw_jedi/primary/bronze/Luke.png`
```
...
**Young Luke (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Luke.png`
```
...
**The Father (Vader)** → `assets/weeks/films/sw_jedi/primary/bronze/Vader.png`
```
...
**The Father (Vader) (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Vader.png`
```
...
**Yoda** → `assets/weeks/films/sw_jedi/primary/bronze/Yoda.png`
```
...
**Yoda (colored)** → `assets/weeks/films/sw_jedi/primary/colored/Yoda.png`
```
...
**Tarkin** → `assets/weeks/films/sw_sith/primary/bronze/Tarkin.png`
```
...
**Tarkin (colored)** → `assets/weeks/films/sw_sith/primary/colored/Tarkin.png`
```
...
**General Grievous** → `assets/weeks/films/sw_sith/primary/bronze/Grievous.png`
```
...
**General Grievous (colored)** → `assets/weeks/films/sw_sith/primary/colored/Grievous.png`
```
...
**Jabba the Hutt** → `assets/weeks/films/sw_sith/primary/bronze/Jabba.png`
```
...
**Jabba the Hutt (colored)** → `assets/weeks/films/sw_sith/primary/colored/Jabba.png`
```
...
**Count Dooku** → `assets/weeks/films/sw_sith/primary/bronze/Dooku.png`
```
...
**Count Dooku (colored)** → `assets/weeks/films/sw_sith/primary/colored/Dooku.png`
```
...
**Maul** → `assets/weeks/films/sw_sith/primary/bronze/Maul.png`
```
...
**Maul (colored)** → `assets/weeks/films/sw_sith/primary/colored/Maul.png`
```
...
**Palpatine** → `assets/weeks/films/sw_sith/primary/bronze/Palpatine.png`
```
...
**Palpatine (colored)** → `assets/weeks/films/sw_sith/primary/colored/Palpatine.png`
```
...
**Anakin** → `assets/weeks/films/sw_sith/primary/bronze/Anakin.png`
```
...
**Anakin (colored)** → `assets/weeks/films/sw_sith/primary/colored/Anakin.png`
```
...
**Darth Plagueis** → `assets/weeks/films/sw_sith/primary/bronze/Plagueis.png`
```
...
**Darth Plagueis (colored)** → `assets/weeks/films/sw_sith/primary/colored/Plagueis.png`
```
...
**Rose Tico** → `assets/weeks/films/sw_dyad/primary/bronze/Rose.png`
```
...
**Rose Tico (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Rose.png`
```
...
**Finn** → `assets/weeks/films/sw_dyad/primary/bronze/Finn.png`
```
...
**Finn (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Finn.png`
```
...
**Phasma (alt)** → `assets/weeks/films/sw_dyad/primary/bronze/Phasma.png`
```
...
**Phasma (alt, colored)** → `assets/weeks/films/sw_dyad/primary/colored/Phasma.png`
```
...
**Maz Kanata** → `assets/weeks/films/sw_dyad/primary/bronze/Maz.png`
```
...
**Maz Kanata (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Maz.png`
```
...
**DJ (alt)** → `assets/weeks/films/sw_dyad/primary/bronze/DJ.png`
```
...
**DJ (alt, colored)** → `assets/weeks/films/sw_dyad/primary/colored/DJ.png`
```
...
**Old Leia** → `assets/weeks/films/sw_dyad/primary/bronze/Leia.png`
```
...
**Old Leia (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Leia.png`
```
...
**Old Han** → `assets/weeks/films/sw_dyad/primary/bronze/Han.png`
```
...
**Old Han (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Han.png`
```
...
**General Hux** → `assets/weeks/films/sw_dyad/primary/bronze/Hux.png`
```
...
**General Hux (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Hux.png`
```
...
**Rey** → `assets/weeks/films/sw_dyad/primary/bronze/Rey.png`
```
...
**Rey (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Rey.png`
```
...
**Kylo Ren** → `assets/weeks/films/sw_dyad/primary/bronze/Kylo.png`
```
...
**Kylo Ren (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Kylo.png`
```
...
**The Ghosts** → `assets/weeks/films/sw_dyad/primary/bronze/Ghosts.png`
```
...
**The Ghosts (colored)** → `assets/weeks/films/sw_dyad/primary/colored/Ghosts.png`
```
...
**Exegol (alt)** → `assets/weeks/films/sw_dyad/primary/bronze/Exegol.png`
```
...
**Exegol (alt, colored)** → `assets/weeks/films/sw_dyad/primary/colored/Exegol.png`
```
