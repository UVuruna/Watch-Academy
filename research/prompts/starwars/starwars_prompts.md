...
**Obi-Wan (Ben) Kenobi** → `assets/weeks/films/sw_jedi/primary/ObiWan.png`
```
...
**Obi-Wan (Ben) Kenobi (colored)** → `assets/weeks/films/sw_jedi/colored/ObiWan.png`
```
...
**Leia, General Organa** → `assets/weeks/films/sw_jedi/primary/Leia.png`
```
...
**Leia, General Organa (colored)** → `assets/weeks/films/sw_jedi/colored/Leia.png`
```
...
**Han Solo** → `assets/weeks/films/sw_jedi/primary/Han.png`
```
...
**Han Solo (colored)** → `assets/weeks/films/sw_jedi/colored/Han.png`
```
...
**Qui-Gon Jinn** → `assets/weeks/films/sw_jedi/primary/QuiGon.png`
```
...
**Qui-Gon Jinn (colored)** → `assets/weeks/films/sw_jedi/colored/QuiGon.png`
```
...
**Padmé** → `assets/weeks/films/sw_jedi/primary/Padme.png`
```
...
**Padmé (colored)** → `assets/weeks/films/sw_jedi/colored/Padme.png`
```
...
**Chewbacca** → `assets/weeks/films/sw_jedi/primary/Chewbacca.png`
```
...
**Chewbacca (colored)** → `assets/weeks/films/sw_jedi/colored/Chewbacca.png`
```
...
**Young Luke** → `assets/weeks/films/sw_jedi/primary/Luke.png`
```
...
**Young Luke (colored)** → `assets/weeks/films/sw_jedi/colored/Luke.png`
```
...
**The Father (Vader)** → `assets/weeks/films/sw_jedi/primary/Vader.png`
```
...
**The Father (Vader) (colored)** → `assets/weeks/films/sw_jedi/colored/Vader.png`
```
...
**Yoda** → `assets/weeks/films/sw_jedi/primary/Yoda.png`
```
...
**Yoda (colored)** → `assets/weeks/films/sw_jedi/colored/Yoda.png`
```
...
**Tarkin** → `assets/weeks/films/sw_sith/primary/Tarkin.png`
```
...
**Tarkin (colored)** → `assets/weeks/films/sw_sith/colored/Tarkin.png`
```
...
**General Grievous** → `assets/weeks/films/sw_sith/primary/Grievous.png`
```
...
**General Grievous (colored)** → `assets/weeks/films/sw_sith/colored/Grievous.png`
```
...
**Jabba the Hutt** → `assets/weeks/films/sw_sith/primary/Jabba.png`
```
...
**Jabba the Hutt (colored)** → `assets/weeks/films/sw_sith/colored/Jabba.png`
```
...
**Count Dooku** → `assets/weeks/films/sw_sith/primary/Dooku.png`
```
...
**Count Dooku (colored)** → `assets/weeks/films/sw_sith/colored/Dooku.png`
```
...
**Maul** → `assets/weeks/films/sw_sith/primary/Maul.png`
```
...
**Maul (colored)** → `assets/weeks/films/sw_sith/colored/Maul.png`
```
...
**Boba Fett** → `assets/weeks/films/sw_sith/primary/BobaFett.png`
```
...
**Boba Fett (colored)** → `assets/weeks/films/sw_sith/colored/BobaFett.png`
```
...
**Palpatine** → `assets/weeks/films/sw_sith/primary/Palpatine.png`
```
...
**Palpatine (colored)** → `assets/weeks/films/sw_sith/colored/Palpatine.png`
```
...
**Anakin** → `assets/weeks/films/sw_sith/primary/Anakin.png`
```
...
**Anakin (colored)** → `assets/weeks/films/sw_sith/colored/Anakin.png`
```
...
**Darth Plagueis** → `assets/weeks/films/sw_sith/primary/Plagueis.png`
```
...
**Darth Plagueis (colored)** → `assets/weeks/films/sw_sith/colored/Plagueis.png`
```
...
**Rose Tico** → `assets/weeks/films/sw_dyad/primary/Rose.png`
```
...
**Rose Tico (colored)** → `assets/weeks/films/sw_dyad/colored/Rose.png`
```
...
**Finn** → `assets/weeks/films/sw_dyad/primary/Finn.png`
```
...
**Finn (colored)** → `assets/weeks/films/sw_dyad/colored/Finn.png`
```
...
**Phasma (alt)** → `assets/weeks/films/sw_dyad/primary/Phasma.png`
```
...
**Phasma (alt, colored)** → `assets/weeks/films/sw_dyad/colored/Phasma.png`
```
...
**Maz Kanata** → `assets/weeks/films/sw_dyad/primary/Maz.png`
```
...
**Maz Kanata (colored)** → `assets/weeks/films/sw_dyad/colored/Maz.png`
```
...
**DJ (alt)** → `assets/weeks/films/sw_dyad/primary/DJ.png`
```
...
**DJ (alt, colored)** → `assets/weeks/films/sw_dyad/colored/DJ.png`
```
...
**Old Leia** → `assets/weeks/films/sw_dyad/primary/Leia.png`
```
...
**Old Leia (colored)** → `assets/weeks/films/sw_dyad/colored/Leia.png`
```
...
**Old Han** → `assets/weeks/films/sw_dyad/primary/Han.png`
```
...
**Old Han (colored)** → `assets/weeks/films/sw_dyad/colored/Han.png`
```
...
**General Hux** → `assets/weeks/films/sw_dyad/primary/Hux.png`
```
...
**General Hux (colored)** → `assets/weeks/films/sw_dyad/colored/Hux.png`
```
...
**Rey** → `assets/weeks/films/sw_dyad/primary/Rey.png`
```
...
**Rey (colored)** → `assets/weeks/films/sw_dyad/colored/Rey.png`
```
...
**Kylo Ren** → `assets/weeks/films/sw_dyad/primary/Kylo.png`
```
...
**Kylo Ren (colored)** → `assets/weeks/films/sw_dyad/colored/Kylo.png`
```
...
**The Ghosts** → `assets/weeks/films/sw_dyad/primary/Ghosts.png`
```
...
**The Ghosts (colored)** → `assets/weeks/films/sw_dyad/colored/Ghosts.png`
```
...
**Exegol (alt)** → `assets/weeks/films/sw_dyad/primary/Exegol.png`
```
...
**Exegol (alt, colored)** → `assets/weeks/films/sw_dyad/colored/Exegol.png`
```
...
- **Svetla** → `assets/titles/starwars_svetla.png`. Brief: The Council
...
- **Tamna** → `assets/titles/starwars_tamna.png`. Brief: The Rule of
...
- **Nova** → `assets/titles/starwars_nova.png`. Brief: The Dyad — two
