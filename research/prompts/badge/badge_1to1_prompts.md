...
**One — the Judge** (gold, 12h) → `assets/archetypes/trinity/circle/One_Judge.png`
...
**the Devil — the Prosecutor** (red, 20h) → `assets/archetypes/trinity/circle/Devil_Prosecutor.png`
...
**Jesus — the Advocate** (blue, 04h) → `assets/archetypes/trinity/circle/Jesus_Advocate.png`
...
**the Child — the Dawn** (green, 12h) → `assets/archetypes/family/circle/Child_Anchor.png`
...
**the Mother — the Heart** (light red, 20h) → `assets/archetypes/family/circle/Mother_Heart.png`
...
**the Father — the Shield** (light blue, 04h) → `assets/archetypes/family/circle/Father_Shield.png`
...
**Sanguine — the Companion** (spring green `#129412`) → `assets/archetypes/temperaments/circle/Sanguine.png`
...
**Choleric — the Commander** (summer yellow `#D9D900`) → `assets/archetypes/temperaments/circle/Choleric.png`
...
**Melancholic — the Thinker** (autumn red `#D4330F`) → `assets/archetypes/temperaments/circle/Melancholic.png`
...
**Phlegmatic — the Peacemaker** (winter blue `#0A70D8`) → `assets/archetypes/temperaments/circle/Phlegmatic.png`
...
**The One — Love** (yellow, 12h) → `assets/archetypes/persons/circle/One_Love.png`
...
**Michael the Archangel — Courage** (orange, 16h) → `assets/archetypes/persons/circle/Michael_Courage.png`
...
**Lucifer — Pride** (red, 20h) → `assets/archetypes/persons/circle/Lucifer_Pride.png`
...
**the Devil — Hatred** (purple, 24h) → `assets/archetypes/persons/circle/Devil_Hatred.png`
...
**Judas — Weakness (Fear)** (blue, 04h) → `assets/archetypes/persons/circle/Judas_Fear.png`
...
**Jesus — Humility** (green, 08h) → `assets/archetypes/persons/circle/Jesus_Humility.png`
...
**Gratitude** (green, 12h) → `assets/archetypes/one_soul/circle/Gratitude.png`
...
**Support** (yellow, 16h) → `assets/archetypes/one_soul/circle/Support.png`
...
**Passion** (red, 20h) → `assets/archetypes/one_soul/circle/Passion.png`
...
**Tolerance** (magenta, 24h) → `assets/archetypes/one_soul/circle/Tolerance.png`
...
**Trust** (blue, 04h) → `assets/archetypes/one_soul/circle/Trust.png`
...
**Respect** (cyan, 08h) → `assets/archetypes/one_soul/circle/Respect.png`
...
**The King** (royal gold, 12h) → `assets/archetypes/walks/circle/King.png`
...
**The Merchant** (copper, 15h) → `assets/archetypes/walks/circle/Merchant.png`
...
**The Soldier** (iron-blood crimson, 18h) → `assets/archetypes/walks/circle/Soldier.png`
...
**The Artist** (stage velvet violet, 21h) → `assets/archetypes/walks/circle/Artist.png`
...
**The Wanderer** (road-dust indigo-charcoal, 24h) → `assets/archetypes/walks/circle/Wanderer.png`
...
**The Scholar** (lamplit ink blue, 03h) → `assets/archetypes/walks/circle/Scholar.png`
...
**The Farmer** (field green, 06h) → `assets/archetypes/walks/circle/Farmer.png`
...
**The Priest** (alb ivory, 09h) → `assets/archetypes/walks/circle/Priest.png`
...
**the Unborn — the seed** (predawn mist `#8FA8C8`, 03h) → `assets/archetypes/life/circle/tree/Unborn.png`
...
**Birth — the sprout** (pale rose `#FFD9CC`, 06h) → `assets/archetypes/life/circle/tree/Birth.png`
...
**Childhood — the sapling** (spring green `#7CE577`, 09h) → `assets/archetypes/life/circle/tree/Childhood.png`
...
**Youth — the blossoming crown** (sun yellow `#FFE800`, 12h) → `assets/archetypes/life/circle/tree/Youth.png`
...
**Maturity — the full crown** (amber `#FFB400`, 15h) → `assets/archetypes/life/circle/tree/Maturity.png`
...
**the Elder — the fruited crown** (ember `#FF6A3C`, 18h) → `assets/archetypes/life/circle/tree/Elder.png`
...
**Old age — the leaf-fall** (dusk violet `#9C6BD4`, 21h) → `assets/archetypes/life/circle/tree/OldAge.png`
...
**Death — the bare tree** (moonlight silver `#C8D7F0`, 24h) → `assets/archetypes/life/circle/tree/Death.png`
