...
**Drop paths:** `assets/archetypes/<family>/circle/colored/<Stem>.png`
...
**One — the Judge** (gold, 12h) → `assets/archetypes/trinity/circle/colored/One_Judge.png`
...
**the Devil — the Prosecutor** (red, 20h) → `assets/archetypes/trinity/circle/colored/Devil_Prosecutor.png`
...
**Jesus — the Advocate** (blue, 04h) → `assets/archetypes/trinity/circle/colored/Jesus_Advocate.png`
...
**the Child — the Dawn** (green, 12h) → `assets/archetypes/family/circle/colored/Child_Anchor.png`
...
**the Mother — the Heart** (light red, 20h) → `assets/archetypes/family/circle/colored/Mother_Heart.png`
...
**the Father — the Shield** (light blue, 04h) → `assets/archetypes/family/circle/colored/Father_Shield.png`
...
**Sanguine — the Companion** (spring green `#129412`) → `assets/archetypes/temperaments/circle/colored/Sanguine.png`
...
**Choleric — the Commander** (summer yellow `#D9D900`) → `assets/archetypes/temperaments/circle/colored/Choleric.png`
...
**Melancholic — the Thinker** (autumn red `#D4330F`) → `assets/archetypes/temperaments/circle/colored/Melancholic.png`
...
**Phlegmatic — the Peacemaker** (winter blue `#0A70D8`) → `assets/archetypes/temperaments/circle/colored/Phlegmatic.png`
...
**The One — Love** (yellow, 12h) → `assets/archetypes/persons/circle/colored/One_Love.png`
...
**Michael the Archangel — Courage** (orange, 16h) → `assets/archetypes/persons/circle/colored/Michael_Courage.png`
...
**Lucifer — Pride** (red, 20h) → `assets/archetypes/persons/circle/colored/Lucifer_Pride.png`
...
**the Devil — Hatred** (purple, 24h) → `assets/archetypes/persons/circle/colored/Devil_Hatred.png`
...
**Judas — Weakness (Fear)** (blue, 04h) → `assets/archetypes/persons/circle/colored/Judas_Fear.png`
...
**Jesus — Humility** (green, 08h) → `assets/archetypes/persons/circle/colored/Jesus_Humility.png`
...
**Gratitude** (green, 12h) → `assets/archetypes/one_soul/circle/colored/Gratitude.png`
...
**Support** (yellow, 16h) → `assets/archetypes/one_soul/circle/colored/Support.png`
...
**Passion** (red, 20h) → `assets/archetypes/one_soul/circle/colored/Passion.png`
...
**Tolerance** (magenta, 24h) → `assets/archetypes/one_soul/circle/colored/Tolerance.png`
...
**Trust** (blue, 04h) → `assets/archetypes/one_soul/circle/colored/Trust.png`
...
**Respect** (cyan, 08h) → `assets/archetypes/one_soul/circle/colored/Respect.png`
...
**The King** (royal gold, 12h) → `assets/archetypes/walks/circle/colored/King.png`
...
**The Merchant** (copper, 15h) → `assets/archetypes/walks/circle/colored/Merchant.png`
...
**The Soldier** (iron-blood crimson, 18h) → `assets/archetypes/walks/circle/colored/Soldier.png`
...
**The Artist** (stage velvet violet, 21h) → `assets/archetypes/walks/circle/colored/Artist.png`
...
**The Wanderer** (road-dust indigo-charcoal, 24h) → `assets/archetypes/walks/circle/colored/Wanderer.png`
...
**The Scholar** (lamplit ink blue, 03h) → `assets/archetypes/walks/circle/colored/Scholar.png`
...
**The Farmer** (field green, 06h) → `assets/archetypes/walks/circle/colored/Farmer.png`
...
**The Priest** (alb ivory, 09h) → `assets/archetypes/walks/circle/colored/Priest.png`
...
**the Unborn — the seed** (predawn mist `#8FA8C8`, 03h) → `assets/archetypes/life/circle/colored/Unborn.png`
...
**Birth — the sprout** (pale rose `#FFD9CC`, 06h) → `assets/archetypes/life/circle/colored/Birth.png`
...
**Childhood — the sapling** (spring green `#7CE577`, 09h) → `assets/archetypes/life/circle/colored/Childhood.png`
...
**Youth — the blossoming crown** (sun yellow `#FFE800`, 12h) → `assets/archetypes/life/circle/colored/Youth.png`
...
**Maturity — the full crown** (amber `#FFB400`, 15h) → `assets/archetypes/life/circle/colored/Maturity.png`
...
**the Elder — the fruited crown** (ember `#FF6A3C`, 18h) → `assets/archetypes/life/circle/colored/Elder.png`
...
**Death — the bare tree** (moonlight silver `#C8D7F0`, 24h) → `assets/archetypes/life/circle/colored/Death.png`
