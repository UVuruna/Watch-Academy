...
- `assets/archetypes/trinity/primary/colored/badges/colored/Faith.png`, `Hope.png`, `Love.png`
...
- `assets/celestial/seasons/badges/turning_point/Summer_Solstice.png`,
...
- `assets/celestial/seasons/badges/meteorological/Spring.png`, `Summer.png`, `Autumn.png`,
...
**Faith (yellow — the center's own axis, vertical, toward God)** → `assets/archetypes/trinity/primary/colored/badges/colored/Faith.png`
```
...
**Hope (blue — the dawn arm, the horizon, toward what comes)** → `assets/archetypes/trinity/primary/colored/badges/colored/Hope.png`
```
...
**Love (red — Venus' arm, among people)** → `assets/archetypes/trinity/primary/colored/badges/colored/Love.png`
```
...
**Spring (green — the union of the poles, light and dark in equal parts)** → `assets/celestial/seasons/badges/Spring.png`
```
...
**Summer (yellow-gold — the light pole, the year's longest light)** → `assets/celestial/seasons/badges/Summer.png`
```
...
**Autumn (red-orange — Steigerung, the light going down fighting)** → `assets/celestial/seasons/badges/Autumn.png`
```
...
**Winter (deep blue — the dark pole, the year's longest dark)** → `assets/celestial/seasons/badges/Winter.png`
```
...
**Wet Season (lush green & rain silver — the tropics' light half)** → `assets/celestial/seasons/badges/Wet_Season.png`
```
...
**Dry Season (bleached gold & dust — the tropics' other half)** → `assets/celestial/seasons/badges/Dry_Season.png`
```
...
**Summer Solstice (all gold — the year's shortest shadow)** → `assets/celestial/seasons/badges/turning_point/Summer_Solstice.png`
```
...
**Winter Solstice (all silver-blue — the year's longest shadow)** → `assets/celestial/seasons/badges/turning_point/Winter_Solstice.png`
```
...
**Equinox (exact half gold, half silver — the day of perfect balance)** → `assets/celestial/seasons/badges/turning_point/Equinox.png`
```
...
**Meteorological Spring** → `assets/celestial/seasons/badges/meteorological/Spring.png`
```
...
**Meteorological Summer** → `assets/celestial/seasons/badges/meteorological/Summer.png`
```
...
**Meteorological Autumn** → `assets/celestial/seasons/badges/meteorological/Autumn.png`
```
...
**Meteorological Winter** → `assets/celestial/seasons/badges/meteorological/Winter.png`
```
