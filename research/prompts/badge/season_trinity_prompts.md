...
**Faith (yellow — the center's own axis, vertical, toward God)**
```
...
**Hope (blue — the dawn arm, the horizon, toward what comes)**
```
...
**Love (red — Venus' arm, among people)**
```
...
**Spring (green — the union of the poles, light and dark in equal parts)**
```
...
**Summer (yellow-gold — the light pole, the year's longest light)**
```
...
**Autumn (red-orange — Steigerung, the light going down fighting)**
```
...
**Winter (deep blue — the dark pole, the year's longest dark)**
```
...
**Wet Season (lush green & rain silver — the tropics' light half)**
```
...
**Dry Season (bleached gold & dust — the tropics' other half)**
```
...
**Summer Solstice (all gold — the year's shortest shadow)**
```
...
**Winter Solstice (all silver-blue — the year's longest shadow)**
```
...
**Equinox (exact half gold, half silver — the day of perfect balance)**
```
