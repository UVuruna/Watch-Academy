...
Drop location: `assets/weeks/inner_wheel/sin/<Name>.png` — Pride, Servility,
...
**Pride (Sunday — Ruler face)** → `assets/weeks/inner_wheel/sin/Pride.png`
```
...
**Servility (Sunday — Servant face, the DUAL)** → `assets/weeks/inner_wheel/sin/Servility.png`
```
...
**Fear (Monday)** → `assets/weeks/inner_wheel/sin/Fear.png`
```
...
**Wrath (Tuesday)** → `assets/weeks/inner_wheel/sin/Wrath.png`
```
...
**Greed (Wednesday)** → `assets/weeks/inner_wheel/sin/Greed.png`
```
...
**Excess (Thursday)** → `assets/weeks/inner_wheel/sin/Excess.png`
```
...
**Jealousy (Friday)** → `assets/weeks/inner_wheel/sin/Jealousy.png`
```
...
**Envy (Saturday)** → `assets/weeks/inner_wheel/sin/Envy.png`
```
