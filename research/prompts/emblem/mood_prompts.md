...
Drop location: `assets/weeks/inner_wheel/mood/<Name>.png` — Glory, Awe (rename
...
**Glory (Sunday — Ruler face)** → `assets/weeks/inner_wheel/mood/Glory.png`
```
...
Eclipse stays an EVENT, not a feeling.* → `assets/weeks/inner_wheel/mood/Awe.png`
```
...
**Calm (Monday)** → `assets/weeks/inner_wheel/mood/Calm.png`
```
...
**Zeal (Tuesday)** → `assets/weeks/inner_wheel/mood/Zeal.png`
```
...
**Sorrow (Wednesday)** → `assets/weeks/inner_wheel/mood/Sorrow.png`
```
...
**Joy (Thursday)** → `assets/weeks/inner_wheel/mood/Joy.png`
```
...
**Passion (Friday)** → `assets/weeks/inner_wheel/mood/Passion.png`
```
...
**Renewal (Saturday)** → `assets/weeks/inner_wheel/mood/Renewal.png`
```
...
**Eclipse (the Ninth Mood)** → `assets/weeks/inner_wheel/mood/Eclipse.png`
```
