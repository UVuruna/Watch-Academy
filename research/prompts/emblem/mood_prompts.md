...
Drop location: `assets/weeks/inner_wheel/mood/primary/colored/<Name>.png` — Glory, Awe (rename
...
**Glory (Sunday — Ruler face)** → `assets/weeks/inner_wheel/mood/primary/colored/Glory.png`
```
...
Eclipse stays an EVENT, not a feeling.* → `assets/weeks/inner_wheel/mood/primary/colored/Awe.png`
```
...
**Calm (Monday)** → `assets/weeks/inner_wheel/mood/primary/colored/Calm.png`
```
...
**Zeal (Tuesday)** → `assets/weeks/inner_wheel/mood/primary/colored/Zeal.png`
```
...
**Sorrow (Wednesday)** → `assets/weeks/inner_wheel/mood/primary/colored/Sorrow.png`
```
...
**Joy (Thursday)** → `assets/weeks/inner_wheel/mood/primary/colored/Joy.png`
```
...
**Passion (Friday)** → `assets/weeks/inner_wheel/mood/primary/colored/Passion.png`
```
...
**Renewal (Saturday)** → `assets/weeks/inner_wheel/mood/primary/colored/Renewal.png`
```
...
**Eclipse (the Ninth Mood)** → `assets/weeks/inner_wheel/mood/primary/colored/Eclipse.png`
```
