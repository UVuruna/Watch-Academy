...
`primary/Skoll.png` → `assets/weeks/myth/norse/colored/Skoll.png`):
...
**Sunday — Sol** → `assets/weeks/myth/norse/primary/Sol.png`
...
**Monday — Mani** → `assets/weeks/myth/norse/primary/Mani.png`
...
**Tuesday — Tyr** → `assets/weeks/myth/norse/primary/Tyr.png`
...
**Wednesday — Odin** → `assets/weeks/myth/norse/primary/Odin.png`
...
**Thursday — Thor** → `assets/weeks/myth/norse/primary/Thor.png`
...
**Friday — Freya** → `assets/weeks/myth/norse/primary/Freya.png`
...
**Saturday — Loki** → `assets/weeks/myth/norse/primary/Loki.png`
...
**Sunday (dual) — Skoll** → `assets/weeks/myth/norse/primary/Skoll.png`
...
**Sunday — Sol** → `assets/weeks/myth/norse/colored/Sol.png`
```
...
**Monday — Mani** → `assets/weeks/myth/norse/colored/Mani.png`
```
...
**Tuesday — Tyr** → `assets/weeks/myth/norse/colored/Tyr.png`
```
...
**Wednesday — Odin** → `assets/weeks/myth/norse/colored/Odin.png`
```
...
**Thursday — Thor** → `assets/weeks/myth/norse/colored/Thor.png`
```
...
**Friday — Freya** → `assets/weeks/myth/norse/colored/Freya.png`
```
...
**Saturday — Loki** → `assets/weeks/myth/norse/colored/Loki.png`
```
...
**Sunday (dual) — Skoll** → `assets/weeks/myth/norse/colored/Skoll.png` — **NEW, the missing plate**
...
**Sunday — Odin the Allfather** → `assets/weeks/myth/norse/pantheon/Odin.png` — **NEW**
...
**Monday — Hel** → `assets/weeks/myth/norse/pantheon/Hel.png` — **NEW**
...
Pantheon Tuesday slot at the existing `assets/weeks/myth/norse/primary/Thor.png`.
...
slot at the existing `assets/weeks/myth/norse/primary/Loki.png`.
...
`assets/weeks/myth/norse/primary/Tyr.png`.

**Friday — Frigg** → `assets/weeks/myth/norse/pantheon/Frigg.png` — **NEW**
...
**Saturday — Freyr** → `assets/weeks/myth/norse/pantheon/Freyr.png` — **NEW**
...
Pantheon dual slot at the existing `assets/weeks/myth/norse/primary/Odin.png`
(the Planetary Wednesday plate, unchanged).

**Ninth (both rosters) — Yggdrasil** → `assets/weeks/myth/norse/pantheon/Yggdrasil.png` — **NEW**
...
**Tuesday — Thor** → REUSE `assets/weeks/myth/norse/colored/Thor.png`

*No new plate.* Same day-shift as the bronze note above — point at
`assets/weeks/myth/norse/colored/Thor.png`.

**Wednesday — Loki** → REUSE `assets/weeks/myth/norse/colored/Loki.png`

*No new plate.* Point at `assets/weeks/myth/norse/colored/Loki.png`.

**Thursday — Tyr** → REUSE `assets/weeks/myth/norse/colored/Tyr.png`

*No new plate.* Point at `assets/weeks/myth/norse/colored/Tyr.png`.
...
**Sunday (dual) — Odin the Wanderer** → REUSE `assets/weeks/myth/norse/colored/Odin.png`

*No new plate.* Point at `assets/weeks/myth/norse/colored/Odin.png` (the
