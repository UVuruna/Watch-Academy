...
| Day | Body | Creed | File |
|---|---|---|---|
| Sunday | sun | Christianity (dual: Satanism) | `assets/weeks/faith/creeds/primary/christianity.png` / `assets/weeks/faith/creeds/primary/satanism.png` |
| Monday | moon | Islam | `assets/weeks/faith/creeds/primary/islam.png` |
| Tuesday | mars | Buddhism | `assets/weeks/faith/creeds/primary/buddhism.png` |
| Wednesday | mercury | Taoism | `assets/weeks/faith/creeds/primary/taoism.png` |
| Thursday | jupiter | Hinduism | `assets/weeks/faith/creeds/primary/hinduism.png` |
| Friday | venus | Sikhism | `assets/weeks/faith/creeds/primary/sikhism.png` |
| Saturday | saturn | Judaism | `assets/weeks/faith/creeds/primary/judaism.png` |
...
**Sunday — Christianity** → `assets/weeks/faith/creeds/primary/christianity.png`
...
**Monday — Islam** → `assets/weeks/faith/creeds/primary/islam.png`
...
**Tuesday — Buddhism** → `assets/weeks/faith/creeds/primary/buddhism.png`
...
**Wednesday — Taoism** → `assets/weeks/faith/creeds/primary/taoism.png`
...
**Thursday — Hinduism** → `assets/weeks/faith/creeds/primary/hinduism.png`
...
**Friday — Sikhism** → `assets/weeks/faith/creeds/primary/sikhism.png`
...
**Saturday — Judaism** → `assets/weeks/faith/creeds/primary/judaism.png`
...
## Dual — Christianity / Satanism (`assets/weeks/faith/creeds/primary/satanism.png`)
...
flat at `assets/weeks/faith/creeds/primary/rough_ashlar.png`): no longer
...
`assets/weeks/faith/creeds/primary/washbasin.png`):
...
(now flat at `assets/weeks/faith/creeds/primary/perfect_ashlar.png`, only
...
1. **Generate NEW art — one plate:** the Satanism dual
   (`assets/weeks/faith/creeds/primary/satanism.png`). Everything else in this theme already exists.
2. **Move — sikhism.png**: copy `assets/weeks/faith/creeds/secondary/sikhism.png`
   → `assets/weeks/faith/creeds/primary/sikhism.png` (implementation
...
6. **Leave on disk, unused — `assets/weeks/faith/creeds/primary/rough_ashlar.png`**: the superseded
