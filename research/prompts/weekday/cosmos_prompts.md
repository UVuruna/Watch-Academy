...
|-----|--------|-----------|----------------|
| Sun ☉ (ruler) | **Sun** | `assets/weeks/celestial_bodies/cosmos/primary/sun.png` | the star that neither explodes nor collapses — the zero of the scale |
| Sun ☉ (servant, dual) | **Black Hole** | `assets/weeks/celestial_bodies/cosmos/primary/black_hole.png` | the star that fell into itself, light not allowed to leave |
| Mon ☽ | **Nebula** | `assets/weeks/celestial_bodies/cosmos/primary/nebula.png` | Calm / Serenity — a stellar nursery |
| Tue ♂ | **Supernova** | `assets/weeks/celestial_bodies/cosmos/primary/supernova.png` | Zeal, Courage / Wrath — the explosion |
| Wed ☿ | **Pulsar** | `assets/weeks/celestial_bodies/cosmos/primary/pulsar.png` | the midnight mind — precise as ticking |
| Thu ♃ | **Galaxy** | `assets/weeks/celestial_bodies/cosmos/primary/galaxy.png` | Generosity — the wheel holding billions |
| Fri ♀ | **Binary Stars** | `assets/weeks/celestial_bodies/cosmos/primary/binary_stars.png` | Love, the pair |
| Sat ♄ | **Comet** | `assets/weeks/celestial_bodies/cosmos/primary/comet.png` | Patience / Renewal — the returning wanderer |
...
- `assets/weekday/cosmos/primary/` — `assets/weeks/celestial_bodies/cosmos/primary/sun.png`, `assets/weeks/celestial_bodies/cosmos/primary/nebula.png`, `assets/weeks/celestial_bodies/cosmos/primary/supernova.png`,
  `assets/weeks/celestial_bodies/cosmos/primary/pulsar.png`, `assets/weeks/celestial_bodies/cosmos/primary/galaxy.png`, `assets/weeks/celestial_bodies/cosmos/primary/binary_stars.png`, `assets/weeks/celestial_bodies/cosmos/primary/comet.png`
- `assets/weeks/celestial_bodies/cosmos/primary/black_hole.png`
- `assets/weekday/cosmos/colored/` — same seven stems
- `assets/weeks/celestial_bodies/cosmos/colored/black_hole.png`

---

## Bronze plates

### Sunday, ruler face — the Sun (`assets/weeks/celestial_bodies/cosmos/primary/sun.png`)
...
### Sunday, servant face (dual) — Black Hole (`assets/weeks/celestial_bodies/cosmos/primary/black_hole.png`)
...
### Monday — Nebula (`assets/weeks/celestial_bodies/cosmos/primary/nebula.png`)
...
### Tuesday — Supernova (`assets/weeks/celestial_bodies/cosmos/primary/supernova.png`)
...
### Wednesday — Pulsar (`assets/weeks/celestial_bodies/cosmos/primary/pulsar.png`)
...
### Thursday — Galaxy (`assets/weeks/celestial_bodies/cosmos/primary/galaxy.png`)
...
### Friday — Binary Stars (`assets/weeks/celestial_bodies/cosmos/primary/binary_stars.png`)
...
### Saturday — Comet (`assets/weeks/celestial_bodies/cosmos/primary/comet.png`)
...
### Sunday, ruler face — the Sun (`assets/weeks/celestial_bodies/cosmos/colored/sun.png`)
...
### Sunday, servant face (dual) — Black Hole (`assets/weeks/celestial_bodies/cosmos/colored/black_hole.png`)
...
### Monday — Nebula (`assets/weeks/celestial_bodies/cosmos/colored/nebula.png`)
...
### Tuesday — Supernova (`assets/weeks/celestial_bodies/cosmos/colored/supernova.png`)
...
### Wednesday — Pulsar (`assets/weeks/celestial_bodies/cosmos/colored/pulsar.png`)
...
### Thursday — Galaxy (`assets/weeks/celestial_bodies/cosmos/colored/galaxy.png`)
...
### Friday — Binary Stars (`assets/weeks/celestial_bodies/cosmos/colored/binary_stars.png`)
...
### Saturday — Comet (`assets/weeks/celestial_bodies/cosmos/colored/comet.png`)
...
## The Ninth — the Big Bang (`assets/weeks/celestial_bodies/cosmos/primary/big_bang.png`)
...
**The Big Bang (colored)** → `assets/weeks/celestial_bodies/cosmos/colored/big_bang.png`
```
