...
|-----|--------|-----------|----------------|
| Sun ☉ (ruler) | **Sun** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/sun.png` | the star that neither explodes nor collapses — the zero of the scale |
| Sun ☉ (servant, dual) | **Black Hole** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/black_hole.png` | the star that fell into itself, light not allowed to leave |
| Mon ☽ | **Nebula** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/nebula.png` | Calm / Serenity — a stellar nursery |
| Tue ♂ | **Supernova** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/supernova.png` | Zeal, Courage / Wrath — the explosion |
| Wed ☿ | **Pulsar** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/pulsar.png` | the midnight mind — precise as ticking |
| Thu ♃ | **Galaxy** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/galaxy.png` | Generosity — the wheel holding billions |
| Fri ♀ | **Binary Stars** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/binary_stars.png` | Love, the pair |
| Sat ♄ | **Comet** | `assets/weeks/celestial_bodies/cosmos/primary/bronze/comet.png` | Patience / Renewal — the returning wanderer |
...
### Sunday, ruler face — the Sun (`assets/weeks/celestial_bodies/cosmos/primary/bronze/sun.png`)
...
### Sunday, servant face (dual) — Black Hole (`assets/weeks/celestial_bodies/cosmos/primary/bronze/black_hole.png`)
...
### Monday — Nebula (`assets/weeks/celestial_bodies/cosmos/primary/bronze/nebula.png`)
...
### Tuesday — Supernova (`assets/weeks/celestial_bodies/cosmos/primary/bronze/supernova.png`)
...
### Wednesday — Pulsar (`assets/weeks/celestial_bodies/cosmos/primary/bronze/pulsar.png`)
...
### Thursday — Galaxy (`assets/weeks/celestial_bodies/cosmos/primary/bronze/galaxy.png`)
...
### Friday — Binary Stars (`assets/weeks/celestial_bodies/cosmos/primary/bronze/binary_stars.png`)
...
### Saturday — Comet (`assets/weeks/celestial_bodies/cosmos/primary/bronze/comet.png`)
...
### Sunday, ruler face — the Sun (`assets/weeks/celestial_bodies/cosmos/primary/colored/sun.png`)
...
### Sunday, servant face (dual) — Black Hole (`assets/weeks/celestial_bodies/cosmos/primary/colored/black_hole.png`)
...
### Monday — Nebula (`assets/weeks/celestial_bodies/cosmos/primary/colored/nebula.png`)
...
### Tuesday — Supernova (`assets/weeks/celestial_bodies/cosmos/primary/colored/supernova.png`)
...
### Wednesday — Pulsar (`assets/weeks/celestial_bodies/cosmos/primary/colored/pulsar.png`)
...
### Thursday — Galaxy (`assets/weeks/celestial_bodies/cosmos/primary/colored/galaxy.png`)
...
### Friday — Binary Stars (`assets/weeks/celestial_bodies/cosmos/primary/colored/binary_stars.png`)
...
### Saturday — Comet (`assets/weeks/celestial_bodies/cosmos/primary/colored/comet.png`)
...
## The Ninth — the Big Bang (`assets/weeks/celestial_bodies/cosmos/primary/bronze/big_bang.png`)
...
**The Big Bang (colored)** → `assets/weeks/celestial_bodies/cosmos/primary/colored/big_bang.png`
```
