...
`assets/weekday/planets/primary/` (`assets/weekday/planets/art/sun.png` … `assets/weekday/planets/art/saturn.png`, real renders —
...
### Moon (`assets/weekday/planets/art/moon.png`)
...
### Mars (`assets/weekday/planets/art/mars.png`)
...
### Mercury (`assets/weekday/planets/art/mercury.png`)
...
### Jupiter (`assets/weekday/planets/art/jupiter.png`)
...
### Venus (`assets/weekday/planets/art/venus.png`)
...
### Saturn (`assets/weekday/planets/art/saturn.png`)
