...
**Sunday — Dažbog** → `assets/weekday/slavic/primary/dazbog.png`
...
**Monday — Hors** → `assets/weekday/slavic/primary/hors.png`
...
**Tuesday — Svetovid** → `assets/weekday/slavic/primary/svetovid.png`
...
**Wednesday — Veles** → `assets/weekday/slavic/primary/veles.png`
...
**Thursday — Perun** → `assets/weekday/slavic/primary/perun.png`
...
**Friday — Mokoš** → `assets/weekday/slavic/primary/mokos.png`
...
**Saturday — Morana** → `assets/weekday/slavic/primary/morana.png`
...
**Hors (monday)** → `assets/weekday/slavic/colored/hors.png`
...
**Svetovid (tuesday)** → `assets/weekday/slavic/colored/svetovid.png`
...
**Veles (wednesday)** → `assets/weekday/slavic/colored/veles.png`
...
**Perun (thursday)** → `assets/weekday/slavic/colored/perun.png`
...
**Mokoš (friday)** → `assets/weekday/slavic/colored/mokos.png`
...
**Morana (saturday)** → `assets/weekday/slavic/colored/morana.png`
...
**Sunday — Perun** → REUSE `assets/weekday/slavic/primary/perun.png`
...
**Monday — Mokoš** → REUSE `assets/weekday/slavic/primary/mokos.png`
...
**Tuesday — Svetovid** → REUSE `assets/weekday/slavic/primary/svetovid.png`
...
**Wednesday — Svarog** → `assets/weekday/slavic/pantheon/svarog.png`
...
**Thursday — Dažbog** → REUSE `assets/weekday/slavic/primary/dazbog.png`
...
**Friday — Lada** → `assets/weekday/slavic/pantheon/lada.png`
...
**Saturday — Morana** → REUSE `assets/weekday/slavic/primary/morana.png`
...
**Sunday (dual), shadow face — Veles** → REUSE `assets/weekday/slavic/primary/veles.png`
...
**Thursday — Dažbog** → REUSE `assets/weekday/slavic/colored/dazbog.png`

```
REUSE — no new render. Pantheon Thursday reseats `slavic/colored/dazbog.png` verbatim (Planetary Sunday's colored plate).
```

**Friday — Lada** → `assets/weekday/slavic/pantheon/colored/lada.png`
...
**Saturday — Morana** → REUSE `assets/weekday/slavic/colored/morana.png`

```
REUSE — no new render. Pantheon Saturday reuses `slavic/colored/morana.png` verbatim — same seat, both rosters.
```

**Sunday (dual), shadow face — Veles** → REUSE `assets/weekday/slavic/colored/veles.png`
...
## The Ninth — Triglav (`assets/weekday/slavic/primary/triglav.png`)
...
**Triglav (colored)** → `assets/weekday/slavic/colored/triglav.png`
```
...
- [ ] `assets/weekday/slavic/pantheon/svarog.png` — bronze, NEW
- [ ] `assets/weekday/slavic/pantheon/lada.png` — bronze, NEW
- [ ] `assets/weekday/slavic/primary/triglav.png` — bronze, NEW (supersedes `crnobog.png` — do NOT
      generate `crnobog.png`)
- [ ] `assets/weekday/slavic/pantheon/colored/svarog.png` — colored, NEW
- [ ] `assets/weekday/slavic/pantheon/colored/lada.png` — colored, NEW
- [ ] `assets/weekday/slavic/colored/triglav.png` — colored, NEW

**REUSE only — no art to generate, `figure_roster: pantheon` just
points at the existing file:**

- [x] Pantheon Sunday → `primary/perun.png` + `assets/weekday/slavic/colored/perun.png`
- [x] Pantheon Monday → `primary/mokos.png` + `assets/weekday/slavic/colored/mokos.png`
- [x] Pantheon Tuesday → `primary/svetovid.png` + `assets/weekday/slavic/colored/svetovid.png`
- [x] Pantheon Thursday → `primary/dazbog.png` + `assets/weekday/slavic/colored/dazbog.png`
- [x] Pantheon Saturday → `primary/morana.png` + `assets/weekday/slavic/colored/morana.png`
- [x] Pantheon Sunday dual (shadow face) → `primary/veles.png` +
      `assets/weekday/slavic/colored/veles.png`
