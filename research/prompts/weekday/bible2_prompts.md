...
slot family without inventing a new palette. `assets/weekday/bible/secondary/abraham.png` is the
...
### Sunday, ruler face — Abraham (`assets/weekday/bible/secondary/abraham.png`)
...
### Monday — Jonah (`assets/weekday/bible/secondary/jonah.png`)
...
### Tuesday — Samson (`assets/weekday/bible/secondary/samson.png`)
...
### Wednesday — Jacob (`assets/weekday/bible/secondary/jacob.png`)
...
### Thursday — Noah (`assets/weekday/bible/secondary/noah.png`)
...
### Friday, primary — Ruth (`assets/weekday/bible/secondary/ruth.png`)
...
### Friday, alternative — Esther (`assets/weekday/bible/secondary/esther_alt.png`)
...
### Saturday — Job (`assets/weekday/bible/secondary/job.png`)
...
## The Ninth — Melchizedek (`assets/weekday/bible/secondary/melchizedek.png`)
...
plate, `ancient_of_days.png`, rather than this set's `assets/weekday/bible/secondary/abraham.png` —
...
- **Ninth — Melchizedek:** relocated here from the base Bible theme;
  ...
  move; needs `assets/weekday/bible/secondary/melchizedek.png` generated.

**Net new generation work from this round:** `assets/weekday/bible/secondary/melchizedek.png`.
