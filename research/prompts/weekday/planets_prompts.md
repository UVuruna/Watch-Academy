...
Drop at `assets/weekday/planets/primary/dual/sun_eclipse.png`.
...
- **Planets ART** — the bronze-medallion treatment of these same seven
  ...
  (`planets/art/dual/sun_eclipse.png`). Not duplicated here.
- **Planet signs** — the glyph-sigil treatment of the same seven bodies
  ...
  already-written Eclipsed Sun dual (`planets/signs/dual/sun_eclipse.png`).
  Not duplicated here.
