...
**Sunday — Helios (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Helios.png`
...
**Monday — Selene (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Selene.png`
...
**Tuesday — Ares (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Ares.png`
...
**Wednesday — Hermes (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Hermes.png`
...
**Thursday — Zeus (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Zeus.png`
...
**Friday — Aphrodite (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Aphrodite.png`
...
**Saturday — Cronus (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Cronus.png`
...
**Sunday (dual) — Phaethon (on disk ✔)** → `assets/weeks/myth/greek/primary/bronze/Phaethon.png`
...
**Helios (sun, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Helios.png`
```
...
**Selene (moon, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Selene.png`
```
...
**Ares (mars, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Ares.png`
```
...
**Hermes (mercury, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Hermes.png`
```
...
**Zeus (jupiter, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Zeus.png`
```
...
**Aphrodite (venus, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Aphrodite.png`
```
...
**Cronus (saturn, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Cronus.png`
```
...
**Phaethon (dual, colored, on disk ✔)** → `assets/weeks/myth/greek/primary/colored/Phaethon.png`
...
`assets/weeks/myth/greek/primary/bronze/Zeus.png` straight into
`assets/weeks/myth/greek/pantheon/bronze/zeus.png` — same enthroned king, same
...
3. **Pantheon bronze — Zeus** → REUSE the existing planetary
   `assets/weeks/myth/greek/primary/bronze/Zeus.png`, no generation.
...
5. **Pantheon colored — Zeus** → REUSE the existing planetary
   `assets/weeks/myth/greek/primary/colored/Zeus.png`, no generation.
