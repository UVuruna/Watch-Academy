...
**Sunday — Helios (on disk ✔)** → `assets/weekday/greek/primary/Helios.png`
...
**Monday — Selene (on disk ✔)** → `assets/weekday/greek/primary/Selene.png`
...
**Tuesday — Ares (on disk ✔)** → `assets/weekday/greek/primary/Ares.png`
...
**Wednesday — Hermes (on disk ✔)** → `assets/weekday/greek/primary/Hermes.png`
...
**Thursday — Zeus (on disk ✔)** → `assets/weekday/greek/primary/Zeus.png`
...
**Friday — Aphrodite (on disk ✔)** → `assets/weekday/greek/primary/Aphrodite.png`
...
**Saturday — Cronus (on disk ✔)** → `assets/weekday/greek/primary/Cronus.png`
...
**Helios (sun, on disk ✔)** → `assets/weekday/greek/colored/Helios.png`
```
...
**Selene (moon, on disk ✔)** → `assets/weekday/greek/colored/Selene.png`
```
...
**Ares (mars, on disk ✔)** → `assets/weekday/greek/colored/Ares.png`
```
...
**Hermes (mercury, on disk ✔)** → `assets/weekday/greek/colored/Hermes.png`
```
...
**Zeus (jupiter, on disk ✔)** → `assets/weekday/greek/colored/Zeus.png`
```
...
**Aphrodite (venus, on disk ✔)** → `assets/weekday/greek/colored/Aphrodite.png`
```
...
**Cronus (saturn, on disk ✔)** → `assets/weekday/greek/colored/Cronus.png`
```
...
`assets/weekday/greek/primary/Zeus.png` straight into
`assets/weekday/greek/pantheon/zeus.png` — same enthroned king, same
...
**Poseidon — moon seat** → `assets/weekday/greek/pantheon/poseidon.png` *(not yet
generated)*
...
**Artemis — mars seat** → `assets/weekday/greek/pantheon/artemis.png` *(not yet generated)*
...
**Athena — mercury seat** → `assets/weekday/greek/pantheon/athena.png` *(not yet
generated)*
...
**Apollo — jupiter seat** → `assets/weekday/greek/pantheon/apollo.png` *(not yet
generated)*
...
**Hera — venus seat** → `assets/weekday/greek/pantheon/hera.png` *(not yet generated)*
...
**Demeter — saturn seat** → `assets/weekday/greek/pantheon/demeter.png` *(not yet
generated)*
...
**Gaia — Pantheon ninth** → `assets/weekday/greek/pantheon/gaia.png` *(not yet generated
...
the existing `assets/weekday/greek/colored/Zeus.png` straight into
`assets/weekday/greek/pantheon/colored/zeus.png` — same colored
enthroned-king badge already generated for the Planetary Thursday
seat, no regeneration.

**Poseidon (colored)** → `assets/weekday/greek/pantheon/colored/poseidon.png` *(not yet
generated)*
```
...
**Artemis (colored)** → `assets/weekday/greek/pantheon/colored/artemis.png` *(not yet
generated)*
```
...
**Athena (colored)** → `assets/weekday/greek/pantheon/colored/athena.png` *(not yet
generated)*
```
...
**Apollo (colored)** → `assets/weekday/greek/pantheon/colored/apollo.png` *(not yet
generated)*
```
...
**Hera (colored)** → `assets/weekday/greek/pantheon/colored/hera.png` *(not yet
generated)*
```
...
**Demeter (colored)** → `assets/weekday/greek/pantheon/colored/demeter.png` *(not yet
generated)*
```
...
**Gaia — Pantheon ninth, colored** → `assets/weekday/greek/pantheon/colored/gaia.png`
*(not yet generated — this REPLACES the retired colored ninth-Hades
plate)*
```
...
3. **Pantheon bronze — Zeus** → REUSE the existing planetary
   `assets/weekday/greek/primary/Zeus.png`, no generation.
...
5. **Pantheon colored — Zeus** → REUSE the existing planetary
   `assets/weekday/greek/colored/Zeus.png`, no generation.
