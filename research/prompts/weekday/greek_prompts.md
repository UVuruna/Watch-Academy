...
(`assets/weeks/myth/greek/pantheon/hades.png` and `assets/weeks/myth/greek/pantheon/colored/hades.png`).
...
**Sunday — Helios (on disk ✔)** → `assets/weeks/myth/greek/primary/Helios.png`
...
**Monday — Selene (on disk ✔)** → `assets/weeks/myth/greek/primary/Selene.png`
...
**Tuesday — Ares (on disk ✔)** → `assets/weeks/myth/greek/primary/Ares.png`
...
**Wednesday — Hermes (on disk ✔)** → `assets/weeks/myth/greek/primary/Hermes.png`
...
**Thursday — Zeus (on disk ✔)** → `assets/weeks/myth/greek/primary/Zeus.png`
...
**Friday — Aphrodite (on disk ✔)** → `assets/weeks/myth/greek/primary/Aphrodite.png`
...
**Saturday — Cronus (on disk ✔)** → `assets/weeks/myth/greek/primary/Cronus.png`
...
**Sunday (dual) — Phaethon (on disk ✔)** → `assets/weeks/myth/greek/primary/Phaethon.png`
...
**Helios (sun, on disk ✔)** → `assets/weeks/myth/greek/colored/Helios.png`
```
...
**Selene (moon, on disk ✔)** → `assets/weeks/myth/greek/colored/Selene.png`
```
...
**Ares (mars, on disk ✔)** → `assets/weeks/myth/greek/colored/Ares.png`
```
...
**Hermes (mercury, on disk ✔)** → `assets/weeks/myth/greek/colored/Hermes.png`
```
...
**Zeus (jupiter, on disk ✔)** → `assets/weeks/myth/greek/colored/Zeus.png`
```
...
**Aphrodite (venus, on disk ✔)** → `assets/weeks/myth/greek/colored/Aphrodite.png`
```
...
**Cronus (saturn, on disk ✔)** → `assets/weeks/myth/greek/colored/Cronus.png`
```
...
**Phaethon (dual, colored, on disk ✔)** → `assets/weeks/myth/greek/colored/Phaethon.png`
...
`assets/weeks/myth/greek/primary/Zeus.png` straight into
`assets/weeks/myth/greek/pantheon/zeus.png` — same enthroned king, same
...
**Poseidon — moon seat** → `assets/weeks/myth/greek/pantheon/poseidon.png` *(not yet
generated)*
...
**Artemis — mars seat** → `assets/weeks/myth/greek/pantheon/artemis.png` *(not yet generated)*
...
**Athena — mercury seat** → `assets/weeks/myth/greek/pantheon/athena.png` *(not yet
generated)*
...
**Apollo — jupiter seat** → `assets/weeks/myth/greek/pantheon/apollo.png` *(not yet
generated)*
...
**Hera — venus seat** → `assets/weeks/myth/greek/pantheon/hera.png` *(not yet generated)*
...
**Demeter — saturn seat** → `assets/weeks/myth/greek/pantheon/demeter.png` *(not yet
generated)*
...
**Hades — Pantheon dual** → `assets/weeks/myth/greek/pantheon/hades.png` *(not yet
...
**Gaia — Pantheon ninth** → `assets/weeks/myth/greek/pantheon/gaia.png` *(not yet generated
...
the existing `assets/weeks/myth/greek/colored/Zeus.png` straight into
...
3. **Pantheon bronze — Zeus** → REUSE the existing planetary
   `assets/weeks/myth/greek/primary/Zeus.png`, no generation.
...
5. **Pantheon colored — Zeus** → REUSE the existing planetary
   `assets/weeks/myth/greek/colored/Zeus.png`, no generation.
