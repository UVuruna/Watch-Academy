---
name: verify
description: Launch/drive recipe for verifying Watch Academy (transparent PySide6 desktop widget) end-to-end on this Windows machine.
---

# Verifying Watch Academy

## Launch

```powershell
python desktop/main.py    # from the repo root; PySide6 6.10 is installed globally
```
...
- Settings: `%APPDATA%\Watch Academy\settings.json` (atomic writes, debounce
